...
C  8136 = QUINAULT RESERVATION
C         (MAPPED TO 800 QUINALT INDIAN RESERVATION)
C  ------------------------
...
C       CROSSWALK FOR RESERVATION PSUEDO CODES & LOCATION CODE
        CASE (8101)
          WRITE(JOSTND,61)
   61     FORMAT(T12,'GRAND RONDE COMMUNITY (8101) BEING MAPPED ',
     &    'TO SIUSLAW NF (612) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (8102)
          WRITE(JOSTND,62)
   62     FORMAT(T12,'SILETZ RESERVATION (8102) BEING MAPPED ',
     &    'TO SIUSLAW NF (612) FOR FURTHER PROCESSING.')
          IFOR =  2
        CASE (8103)
          WRITE(JOSTND,63)
   63     FORMAT(T12,'COOS, LOWER UMPQUA, SIUSLAW OFF-RES TL (8103) ',
     &    'BEING MAPPED TO SIUSLAW NF (612) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (8104)
          WRITE(JOSTND,64)
   64     FORMAT(T12,'COW CREEK RESERVATION (8104) BEING MAPPED ',
     &    'TO BLM - COOS BAY DISTRICT (712) FOR FURTHER PROCESSING.')
          IFOR = 6
        CASE (8105)
          WRITE(JOSTND,65)
   65     FORMAT(T12,'COQUILLE RESERVATION (8105) BEING MAPPED ',
     &    'TO BLM - COOS BAY DISTRICT (712) FOR FURTHER PROCESSING.')
          IFOR = 6
        CASE (8110)
          WRITE(JOSTND,66)
   66     FORMAT(T12,'CHEHALIS RESERVATION (8110) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8111)
          WRITE(JOSTND,67)
   67     FORMAT(T12,'HOH INDIAN RESERVATION (8111) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8113)
          WRITE(JOSTND,68)
   68     FORMAT(T12,'SHOALWATER BAY INDIAN RESERVATION (8113) ',
     &    'BEING MAPPED TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8114)
          WRITE(JOSTND,69)
   69     FORMAT(T12,'SKOKOMISH RESERVATION (8114) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8115)
          WRITE(JOSTND,70)
   70     FORMAT(T12,'SQUAXIN ISLAND RESERVATION (8115) BEING ',
     &    'MAPPED TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8116)
          WRITE(JOSTND,71)
   71     FORMAT(T12,'LOWER ELWHA OFF-RES TL (8116) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8119)
          WRITE(JOSTND,72)
   72     FORMAT(T12,'LUMMI RESERVATION (8119) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8120)
          WRITE(JOSTND,73)
   73     FORMAT(T12,'MUCKLESHOOT RESERVATION (8120) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8121)
          WRITE(JOSTND,74)
   74     FORMAT(T12,'NISQUALLY RESERVATION (8121) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8122)
          WRITE(JOSTND,75)
   75     FORMAT(T12,'PORT GAMBLE RESERVATION (8122) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8123)
          WRITE(JOSTND,76)
   76     FORMAT(T12,'PORT MADISON RESERVATION (8123) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8125)
          WRITE(JOSTND,77)
   77     FORMAT(T12,'SWINOMISH RESERVATION (8125) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8126)
          WRITE(JOSTND,78)
   78     FORMAT(T12,'TULALIP RESERVATION (8126) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8127)
          WRITE(JOSTND,79)
   79     FORMAT(T12,'UPPER SKAGIT RESERVATION (8127) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR = 1
        CASE (8128)
          WRITE(JOSTND,80)
   80     FORMAT(T12,'SAMISH TDSA (8128) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
        ...
        CASE (8129)
          WRITE(JOSTND,81)
   81     FORMAT(T12,'SNOQUALMIE RESERVATION (8129) BEING MAPPED ',
     &    'TO OLYMPIC NF (609) FOR FURTHER PROCESSING.')
          IFOR =  1
        CASE (8136)
          WRITE(JOSTND,82)
   82     FORMAT(T12,'QUINAULT RESERVATION (8136) BEING MAPPED ',
     &    'TO QUINALT INDIAN RESERVATION (800) FOR FURTHER PROCESSING.')
          IFOR = 3
