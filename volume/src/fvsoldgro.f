...
C     REAL DD2MI,H,D,R,PROF1
C----------
C     PROF1=R**1.5 + (-.0052554*H +.000034947*H**2 + .104477
C    1*H/D) * (R**1.5-R**3) +(7.76807/D**2 -.0000094852*H**2 -
C    2.011351*H/D)*(R**1.5-R**32)
C     IF(DD2MI .LT. 0.)DD2MI=0.
C     RETURN
C
C
C     END
