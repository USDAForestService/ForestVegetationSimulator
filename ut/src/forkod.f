...
C
   ...
   20 CONTINUE
      IF(I .EQ. 7)THEN
        WRITE(JOSTND,21)
   21   FORMAT(T13,'CACHE NF (404) BEING MAPPED TO WASATCH ',
     &  '(419) FOR FURTHER PROCESSING.')
        I=6
      ELSEIF(I .EQ. 8)THEN
        WRITE(JOSTND,22)
   22   FORMAT(T13,'HUMBOLDT NF (409) BEING MAPPED TO FISHLAKE ',
     &  '(408) FOR FURTHER PROCESSING.')
        I=3
      ELSEIF(I .EQ. 9)THEN
        WRITE(JOSTND,23)
   23   FORMAT(T13,'TOIYABE NF (417) BEING MAPPED TO FISHLAKE ',
     &  '(408) FOR FURTHER PROCESSING.')
        I=3
      ENDIF
      IFOR=I
