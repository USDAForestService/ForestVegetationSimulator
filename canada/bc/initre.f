...
C
      ...
      REAL    TC,SDHI,SDLO,ARRAY(12),PRMS(10),XBAF
...
C     NECESSARY AND ALL REFERENCES TO ITOPD8 HAVE BEEN REMOVED
      ...
      ARRAY(3) = ARRAY(3)*CMtoIN !MinDBH
      ARRAY(4) = ARRAY(4)*CMtoIN !MinTopD 
      ARRAY(5) = ARRAY(5)*CMtoFT !StumpHt
C     Sawlog specs
      ARRAY(8) = ARRAY(8)*CMtoIN !MinSawDBH
      ARRAY(9) = ARRAY(9)*CMtoIN !MinSawTopD 
      ARRAY(10) = ARRAY(10)*CMtoFT !SawStumpHt
C
C     SPECIES CODE PROCESSING.
C
      CALL SPDECD (2,IS,NSP(1,1),JOSTND,IRECNT,KEYWRD,
...
C
C       INSERT SAWLOG CUBIC SPECS READS HERE IF DESIRED
C
 4510   CONTINUE
 ...
 4520   FORMAT (/A8,'   THE FOLLOWING MERCHANTABILITY ',
     >    'STANDARDS HAVE BEEN CHANGED FOR ALL SPECIES:')
        ...
        IF(LNOTBK(4).AND.LKECHO)WRITE(JOSTND,4522) ARRAY(4)*INtoCM
...
C
C       INSERT WRITE STATEMENTS FOR SAWLOG CUBIC SPECS HERE IF DESIRED
C
...
C
C       INSERT SAWLOG CUBIC SPECS FORMAT STATEMENTS HERE IF DESIRED
C
        GOTO 10
      ELSE
C----------
