      ...
      IMPLICIT NONE
C----------
C  **INTREE--BASE  DATE OF LAST REVISION:  10/14/10
C----------
C
...
C
      ...
      INTEGER II,INOSPC,IPVARS,IDAMCD,IRDPLV,ISDSP
      REAL SDHI,SDLO,THT
...
C
    ...
    5 FORMAT (/' ENTERING SUBROUTINE INTREE.',/
     ...
     &        ' MORDAT: ',L2,'; IRDPLV=',I3)
C
C     SET FLAG TO SEE OF A FILL IS CONNECTED TO ISTDAT. WE WILL TRY TO OPEN
C     ONE IF NECESSARY.
C
      LCONN=.FALSE.
    8 CONTINUE
