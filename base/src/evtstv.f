      ...
      IMPLICIT NONE
C----------
C  **EVTSTV--BASE  DATE OF LAST REVISION: 09/19/11
C----------
C
...
C
C
      IF (LDEB) WRITE (JOSTND,1) IUSERV,ICYC,IPHASE
    1 FORMAT (' IN EVTSTV,IUSERV=',I4,' ICYC=',I4,' IPHASE=',I2)
...
C
   ...
   91 FORMAT (' IN EVTSTV,IPHASE,ICYC=',2I4)
      ...
      TSTV1(1)=IY(ICYC)
      TSTV1(2)=IAGE+IY(ICYC)-IY(1)
      IF(LDEB)WRITE(JOSTND,*)' ICYC,IAGE,IY(ICYC),IY(1),TSTV102= ',
     &ICYC,IAGE,IY(ICYC),IY(1),TSTV1(2)
...
C----------
   ...
   60 CONTINUE
      TSTV1(47)=0.
      IF(BA.GT.0.0 .AND. GROSPC.GT.0.0) TSTV1(47)=(TADWBA/BA)/GROSPC
C----------
C
...
C
   ...
   70 CONTINUE
      TSTV2(16)=0.
      IF(BA.GT.0.0 .AND. GROSPC.GT.0.0)TSTV2(16)=(TADWBA/BA)/GROSPC
      CALL RDCLS2(0,0.,999.,1,CRD,0)
      TSTV2(17)=CRD/GROSPC
C
