...
C  QFATAR= SETS TARGET TYPE 1=TPA, 2=BA, 3=SDI
C
...
C
      ...
      REAL TPA1,DINOM,SUMTAR,CTAR,SUM,EXCESS1,CTPA,SUMINV
      LOGICAL LQFA,LZEIDE,DEBUG1,DEFICIT,LDELQFA
...
C
      ...
      ENDDO
C
      IF(DEBUG1)WRITE(JOSTND1,*)'DEFICIT,TPA1,SUMTAR,TPACLS(J,2)= ',
     &DEFICIT,TPA1,SUMTAR,(TPACLS(J,2),J=1,NDCLS)
