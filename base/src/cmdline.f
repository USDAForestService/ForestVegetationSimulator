...
#ifdef _WINDLL
!DEC$ ATTRIBUTES DLLEXPORT,C,DECORATE,ALIAS : "fvsSetCmdLine" :: FVSSETCMDLINE
...
#ifdef _WINDLL
!DEC$ ATTRIBUTES DLLEXPORT,C,DECORATE,ALIAS : "fvsGetStoppointCodes" :: FVSGETSTOPPOINTCODES
...
#ifdef _WINDLL
!DEC$ ATTRIBUTES DLLEXPORT,C,DECORATE,ALIAS : "fvsSetStoppointCodes" :: FVSSETSTOPPOINTCODES
!DEC$ ATTRIBUTES REFERENCE :: spptcd,spptyr
#endif
...
#ifdef _WINDLL
!DEC$ ATTRIBUTES DLLEXPORT,C,DECORATE,ALIAS : "fvsGetRestartCode" :: FVSGETRESTARTCODE
...
#ifdef _WINDLL
!DEC$ ATTRIBUTES DLLEXPORT,C,DECORATE,ALIAS : "fvsRestartLastStand" :: FVSRESTARTLASTSTAND
!DEC$ ATTRIBUTES REFERENCE :: restrtcd
#endif
...
#ifdef _WINDLL
!DEC$ ATTRIBUTES DLLEXPORT,C,DECORATE,ALIAS : "fvsGetKeywordFileName" :: FVSGETKEYWORDFILENAME
...
#ifdef _WINDLL
!DEC$ ATTRIBUTES DLLEXPORT,C,DECORATE,ALIAS : "fvsSetRtnCode" :: FVSSETRTNCODE
...
#ifdef _WINDLL
!DEC$ ATTRIBUTES DLLEXPORT,C,DECORATE,ALIAS : "fvsGetRtnCode" :: FVSGETRTNCODE
!DEC$ ATTRIBUTES REFERENCE :: rtnCode
#endif
