...
C     THE VARIABLES SPECIFIC TO THE ORGANON LIBRARY. 
C     CALLED AT START-UP (PUT IN HERE THAT LORGANON=.FALSE.
C     CALLED FOR EVERY STAND IN A MULTI-STAND RUN.
C----------
      CALL ORINIT      
...
C     FIVE YEARS
C----------
C     SET THE TIME INTERVAL TO FIVE YEAR INTERVALS
      !TIMEINT            0         5
      DO I=2,MAXCY1
      IY(I) = 5
      END DO
