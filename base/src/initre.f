      ...
      IMPLICIT NONE
C----------
C  **INITRE--BASE  DATE OF LAST REVISION:  10/27/2012
C----------
C
...
C
  ...
  134 FORMAT(T13,'STAND ATTRIBUTES ARE CALCULATED PER ACRE OF ',
...
C
  ...
  131   FORMAT (/' STDINFO    FOREST-LOCATION CODE=',I8,
     ...
     >     '; AGE=',I5,'; ASPECT AZIMUTH IN DEGREES= ',F4.0,
     >       '; SLOPE= ' ,F4.0,'%'/
     > T13,'ELEVATION(10''S FEET)=',F5.1,';  REFERENCE CODE= ',A4)
C
  ...
  135   FORMAT (/1X,A8,'   FOREST-LOCATION CODE=',I8,
     ...
     >  '; AGE=',I5,'; ASPECT AZIMUTH IN DEGREES= ',F4.0,
     >   '; SLOPE= ',F4.0,'%'/
     > T13,'ELEVATION(100''S FEET)=',F5.1,';  REFERENCE CODE= ',A4)
C
      ELSE
...
C----------
 ...
 211     FORMAT ((T13,8(A3,'=',F6.0,:,'; '),A,'=',F6.0))
         IF(ISISP.GT.0)THEN
...
C
 ...
 1405 FORMAT(T13,'ONLY RECORDS WITH DIAMETERS GE',F6.1,
...
C
 ...
 1925 FORMAT(T13,'TRANSITION SIZE = ',F10.2,' INCHES DBH.',
...
C
 ...
 3930 FORMAT(T13,'RESIDUAL CLASS TPA =',F8.1,
...
C
 ...
 4095 FORMAT (/1X,A8,'   DATE/CYCLE=',I5,'; RESIDUAL=',F8.2,
     >        '; PROPORTION OF SELECTED TREES REMOVED=',F6.3/
     >   T13,'DBH OF REMOVED TREES WILL RANGE FROM ',F5.1,' TO ',
     >   F5.1,' INCHES, AND'/
     >   T13,'HEIGHT OF REMOVED TREES WILL RANGE FROM ',F5.1,' TO ',
     >   F5.1,' FEET.')
      GO TO 10
C
 ...
 4332     FORMAT(/1X,A8,T13,'PULPWOOD VOLUME DEFECT PROPORTIONS HAVE ',
     ...
     >       '; 25 INCH AND LARGER TREES=',F6.2)
        ELSE
          ...
          IF(LKECHO)WRITE(JOSTND,4340) KEYWRD,KARD(2)(1:ILEN),IS,
     &                                 (ARRAY(I),I=3,7)
 4340     FORMAT(/1X,A8,T13,'CUBIC FOOT VOLUME DEFECT PROPORTIONS ',
...
C
 ...
 5010   FORMAT (/1X,A8,'   DATE/CYCLE=',I5,'; CUTTING MUST EXCEED ',
     >        'THE FOLLOWING:',/,30X,F8.1,' SAWLOG CUFT,',F8.1,
 ...
 5011   FORMAT (/1X,A8,'   DATE/CYCLE=',I5,'; CUTTING MUST EXCEED ',
     >        'THE FOLLOWING:',/,30X,F8.1,' MERCH CUFT,',F8.1,
...
C
 ...
 9030    FORMAT (/1X,A8,'   DATE/CYCLE=',I5,'; SPECIES=',A,' (CODE=',
     ...
     >   F7.2,' INCHES DBH ARE AFFECTED.'/T13,'TYPE CODE = ',
...
C----------
 ...
 9908   FORMAT(/1X,A8,T13,'DEFAULT COEFFICIENTS FOR CUBIC FOOT VOLUME'/
...
C----------
 ...
 9918   FORMAT(/1X,A8,T13,'DEFAULT COEFFICIENTS FOR CUBIC FOOT VOLUME'/
...
C----------
 ...
 9958   FORMAT(/1X,A8,T13,'DEFAULT COEFFICIENTS FOR BOARD FOOT VOLUME'/
     &              T13,'EQUATIONS REPLACED FOR ALL SPECIES.')
C----------
C     SPECIES CODE IS SPECIFIED (ISPC>0).
C----------
 ...
 9965   CONTINUE
        ILEN=3
        IF(LKECHO)WRITE(JOSTND,9968) KEYWRD,KARD(1)(1:ILEN),ISPC
 9968   FORMAT(/1X,A8,T13,'DEFAULT COEFFICIENTS FOR BOARD FOOT VOLUME'/
     &    T13,'EQUATIONS REPLACED FOR SPECIES= ',A,' (CODE= ',I3,').' )
      ENDIF
C
 9970 CONTINUE
...
10605   FORMAT(/1X,A8,'   DATE/CYCLE=',I5,';  METHOD=',F5.0,
...
11912       FORMAT(/1X,A8,T13,'PULPWOOD VOLUME DEFECT',
     ...
     >       /T13,' 5 INCH TREES=',F6.2,'; 10 INCH TREES=',F6.2,
     >       '; 15 INCH TREES=',F6.2,/T13,'20 INCH TREES=',F6.2,
     >       '; 25 INCH TREES=',F6.2,'; 30 INCH TREES=',F6.2,/T13,
...
14000 CONTINUE
     ...
     &       'EC','EM','NC','SN','SO','TT','UT','WS')
        ...
        IF(LNOTBK(2))DBHSDI=ARRAY(2)
        CALCSDI="STAGE'S"
        IF(LZEIDE)CALCSDI="ZEIDE'S"
        IF(LKECHO)WRITE(JOSTND,14010) KEYWRD,CALCSDI,DBHSDI
14010   FORMAT (/1X,A8,'   ',A7,' SUMMATION METHOD WILL BE ',
     ...
     &  F6.2,' IN')
      ...
      SELECT CASE(VVER(:6))
        ...
        CALCSDI="STAGE'S"
        IF(LZEIDE)CALCSDI="ZEIDE'S"
        IF(LKECHO)WRITE(JOSTND,14020) KEYWRD,CALCSDI,DBHSDI
