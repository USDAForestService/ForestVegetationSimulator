      ...
      IMPLICIT NONE
C----------
C     **PTBAL--BS   DATE OF LAST REVISION:  07/23/08
C----------
C     
...
C     
      ...
      ENDDO
      IF (DEBUG) WRITE (JOSTND,5) ICYC,NP,ITRN,IREC2,PI,GROSPC
    5 FORMAT(' ENTERING SUBROUTINE PTBAL CYCLE=',I5,'; NP=',I4,
     >     '; ITRN=',I5,'; IREC2=',I5,'; PI=',F6.1,'; GROSPC=',F8.3)
C     
