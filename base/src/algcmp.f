     ...
     >    ISTACK,MXSTCK,IOPCOD,IOPS,MXOPS,CONSTS,ILCONS,ITCONS,MXCONS)
      IMPLICIT NONE
C----------
C  **ALGCMP-BS DATE OF LAST REVISION:  08/13/09
C----------
...
C
      ITOKEN=ITOKEN-1
      IF (LDEBUG) WRITE(JOSTND,'(1X,A20)') CTOK
      IF (LNUMB) THEN
...
C
  400 CONTINUE
      WRITE (JOSTND,405)
  405 FORMAT (/T13,'NOT ENOUGH STORAGE TO STORE EXPRESSION.')
      IRC=1
      GOTO 600
  410 CONTINUE
      WRITE (JOSTND,415)
  415 FORMAT (/T13,'MISMATCHED OR OTHER MISUSE OF PARENTHESIS.')
      IRC=2
      GOTO 600
  430 CONTINUE
      WRITE (JOSTND,435)
  435 FORMAT (/T13,'NOT ENOUGH STORAGE TO COMPILE EXPRESSION.')
      IRC=4
      GOTO 600
  440 CONTINUE
      WRITE (JOSTND,445)
  445 FORMAT (/T13,'A COMMA WAS USED WITHOUT AN OPERATOR THAT',
     >       ' ALLOWS ONE.')
      IRC=5
      GOTO 600
  446 CONTINUE
      WRITE (JOSTND,447)
  447 FORMAT (/T13,'TOO MANY COMMAS IN ONE FUNCTION.')
      IRC=5
      GOTO 600
  450 CONTINUE
      WRITE (JOSTND,455)
  455 FORMAT (/T13,'NOT ENOUGH STORAGE TO STORE CONSTANTS IN',
     >       ' THE EXPRESSION.')
      IRC=6
      GOTO 600
  460 CONTINUE
      WRITE (JOSTND,465)
  465 FORMAT (/T13,'A VARIABLE OR NUMBER (TOKEN) IS TOO LONG.')
      IRC=6
      GOTO 600
  470 CONTINUE
      WRITE (JOSTND,475)
  475 FORMAT (/T13,'AN ILLEGAL VARIABLE WAS FOUND.')
      IRC=7
      GOTO 600
  480 CONTINUE
      WRITE (JOSTND,485)
  485 FORMAT (/T13,'A LOGICAL EXPRESSION WAS EXPECTED BUT NOT FOUND.')
      IRC=8
      GOTO 600
  490 CONTINUE
      WRITE (JOSTND,495)
  495 FORMAT (/T13,'NO EXPRESSION WAS FOUND.')
      IRC=9
      GOTO 600
  500 CONTINUE
      IRC=0
