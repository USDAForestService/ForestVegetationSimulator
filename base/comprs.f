...
C
        ...
        CULLI =       CULL   (IREC1) * XP
        DECAYI =   INT(DECAYCD(IREC1) * XP)
        WDLDSTEMI = INT(WDLDSTEM(IREC1) * XP)
...
C
          ...
          DECAYI = INT(DECAYI       + DECAYCD (IREC) * XP)
          WDLDSTEMI = INT(WDLDSTEMI + WDLDSTEM(IREC) * XP)
...
C
        ...
        DECAYCD(IREC1)  = INT(DECAYI / TXP)
        WDLDSTEM(IREC1) = INT(WDLDSTEMI / TXP)
