      ...
      IMPLICIT NONE
C----------
C  **CRATET--EC   DATE OF LAST REVISION:  04/07/11
C----------
...
C----------
      ...
      CHARACTER*4 UNDER
      INTEGER I,J,II,ISPC,IPTR,I1,I2,I3,K1,K2,K3,K4,NH,JJ,JCR,IS,IM
      INTEGER KNT2(MAXSP),KNT(MAXSP)
      REAL SPCNT(MAXSP,3),SITAGE,SITHT,AGMAX,HTMAX,HTMAX2,D1,D2
