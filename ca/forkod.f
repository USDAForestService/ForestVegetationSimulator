...
C       CROSSWALK FOR RESERVATION PSUEDO CODES & LOCATION CODE
        CASE (7801)
          WRITE(JOSTND,70)
   70     FORMAT(T12,'BERRY CREEK OFF-RES. TRUST LAND RESERVATION ',
     &    '(7801) BEING MAPPED TO PLUMAS NF (511) FOR FURTHER ',
     &    'PROCESSING.')
          IFOR = 4

        CASE (7803)
          WRITE(JOSTND,71)
   71     FORMAT(T12,'COLD SPRINGS RANCHERIA (7803) BEING',
     &    ' MAPPED TO PLUMAS NF (511) FOR FURTHER PROCESSING.')
          IFOR = 4

        CASE (7804)
          WRITE(JOSTND,72)
   72     FORMAT(T12,'COLUSA RANCHERIA (7804) BEING MAPPED',
     &    ' TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
          IFOR = 3

        CASE (7805)
          WRITE(JOSTND,73)
   73     FORMAT(T12,'CORTINA INDIAN RANCHERIA (7805) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
          IFOR = 3

        CASE (7809)
          WRITE(JOSTND,74)
   74     FORMAT(T12,'GRINDSTONE INDIAN RANCHERIA (7809) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
          IFOR = 3

        CASE (7811)
          WRITE(JOSTND,75)
   75     FORMAT(T12,'JACKSON RANCHERIA (7811) BEING MAPPED ',
     &    'TO PLUMAS NF (511) FOR FURTHER PROCESSING.')
          IFOR = 4

        CASE (7812)
          WRITE(JOSTND,76)
   76     FORMAT(T12,'CHICKEN RANCH OFF-RES. TRUST LAND (7812) BEING',
     &    ' MAPPED TO PLUMAS NF (511) FOR FURTHER PROCESSING.')
          IFOR = 4

        CASE (7818)
          WRITE(JOSTND,77)
   77     FORMAT(T12,'PICAYUNE OFF-RES. TRUST LAND (7818) BEING ',
     &    'MAPPED TO PLUMAS NF (511) FOR FURTHER PROCESSING.')
          IFOR = 4

        CASE (7822)
          WRITE(JOSTND,78)
   78     FORMAT(T12,'RUMSEY INDIAN RANCHERIA (7822) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
          IFOR = 3

        CASE (7823)
          WRITE(JOSTND,79)
   79     FORMAT(T12,'SHINGLE SPRINGS RANCHERIA (7823) BEING MAPPED ',
     &    'TO PLUMAS NF (511) FOR FURTHER PROCESSING.')
          IFOR = 4

        CASE (7826)
          WRITE(JOSTND,80)
   80     FORMAT(T12,'TABLE MOUNTAIN RANCHERIA (7826) BEING MAPPED ',
     &    'TO PLUMAS NF (511) FOR FURTHER PROCESSING.')
          IFOR = 4

        CASE (7827)
          WRITE(JOSTND,81)
   81     FORMAT(T12,'TULE RIVER RESERVATION (7827) BEING MAPPED ',
     &    'TO PLUMAS NF (511) FOR FURTHER PROCESSING.')
          IFOR = 4

        CASE (7829)
          WRITE(JOSTND,82)
   82     FORMAT(T12,'MOORETOWN OFF-RES. TRUST LAND (7829) BEING ',
     &    'MAPPED TO PLUMAS NF (511) FOR FURTHER PROCESSING.')
          IFOR = 4

        CASE (7837)
          WRITE(JOSTND,83)
   83     FORMAT(T12,'PIT RIVER TRUST LAND (7837) BEING MAPPED ',
     &    'TO LASSEN NF (506) FOR FURTHER PROCESSING.')
          IFOR = 2

        CASE (7842)
          WRITE(JOSTND,84)
   84     FORMAT(T12,'QUARTZ VALLEY RESERVATION (7842) BEING MAPPED ',
     &    'TO KLAMATH NF (505) FOR FURTHER PROCESSING.')
          IFOR = 1

        CASE (7846)
          WRITE(JOSTND,85)
   85     FORMAT(T12,'KARUK OFF-RES. TRUST LAND (7846) BEING MAPPED ',
     &    'TO KLAMATH NF (505) FOR FURTHER PROCESSING.')
          IFOR = 1

        CASE (7864)
          WRITE(JOSTND,86)
   86     FORMAT(T12,'SANTA ROSA RANCHERIA (7864) BEING MAPPED ',
     &    'TO PLUMAS NF (511) FOR FURTHER PROCESSING.')
          IFOR = 4

        CASE (8104)
          WRITE(JOSTND,87)
   87     FORMAT(T12,'COW CREEK RESERVATION (8104) BEING MAPPED ',
