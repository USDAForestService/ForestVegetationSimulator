...
C----------
      ...
      REAL MISDGF
      DIMENSION STDRAT(MAXSP),CORTEM(MAXSP),NUMCAL(MAXSP),PSIGSQ(MAXSP)
...
C
     ...
     &  0.0636,  0.0970,  0.0970,  0.0636,  3*0.0898,0.1556,
     &  0.0898 /
C-----------
C  CHECK FOR DEBUG.
C-----------
...
C
 ...
 9005 FORMAT (/,' WEIGHT GIVEN TO THE INPUT GROWTH DATA WHEN'/
     ...
     >        ((T49,11(F5.2,1X)/)))
C
      WRITE(JOSTND,9006) ((CORTEM(I),CTEM(I)), I= 1, NUMSP)
 9006 FORMAT (/' INITIAL SCALE FACTORS FOR THE'/
     >       ' DBH INCREMENT MODEL',((T49,1X,11(F4.2,A,1X)/)))
C----------
