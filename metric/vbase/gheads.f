...
C----------
   ...
   10   FORMAT(/T41,
     ...
     >  6(6('-'),1X),2X,14('-'),2X,42('-')/T34,'(DBH IN    CMS)')
C----------
...
C----------
   ...
   35   FORMAT(
     ...
     >  4X,'BASAL  TOPHT (M)        '/5X,'TREES/HA',12X,'DBH    HEIGHT',
     >  2X,'CROWN   GROWTH   AREA     PER    STAND   MEAN DBH    PER',
     >  5X,'AREA     LARGEST       '/'YEAR   %TILE  SPECIES  (CMS)  ',
     >  '(METRES)  RATIO     (CMS)  %TILE      HA   AGE        (CMS)',
     >  4X,'  HA  (SQFT/HA) 40/HA            '/'----',2X,2(7('-'),1X),
...
C----------
   ...
   40   FORMAT(
     ...
     >  6X,65('-'),2X,53('-')/6X,'INITIAL',
     >  27X,'LIVE   PAST DBH  BASAL   TREES',10X,'QUADRATIC   TREES',
     >  4X,'BASAL  TOPHT (M)   CROWN'/5X,'TREES/HA',12X,'DBH    HEIGHT',
     >  2X,'CROWN   GROWTH   AREA     PER    STAND   MEAN DBH    PER',
     >  5X,'AREA     LARGEST   COMP'/'YEAR   %TILE  SPECIES  (CMS)  ',
     >  '(METRES)  RATIO     (CMS)  %TILE      HA   AGE        (CMS)',
     >  4X,'  HA  (SQFT/HA) 40/HA      FACTOR'/'----',2X,2(7('-'),1X),
     >  2(8('-'),1X),6('-'),1X,9('-'),1X,7('-'),1X,6('-'),2X,5('-'),2X,
     >  9('-'),3X,6('-'),1X,2(9('-'),1X),7('-'))
      END SELECT
C
