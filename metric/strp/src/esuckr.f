      ...
      IMPLICIT NONE
C----------
C  **ESUCKR--STRP/M DATE OF LAST REVISION:  01/27/11
C----------
COMMONS
      INCLUDE 'PRGPRM.F77'
      INCLUDE 'ARRAYS.F77'
...
C     VALUE OF MAXTRE. COMPRS IS CALLED IN ESNUTR.
      ...
      INTEGER ITRGT,IGRP,IULIM,IG,IGSP
      REAL BACHLO,BX,AX,CRDUM,CW,TPATOT,PREM
      CHARACTER CLABEL*2
...
C
      ...
      HMULT=1.
      DO 450 IT=1,NTODO
      IF((DBHMID(ICL).GE.DMIN(ISPSTO,IT)).AND.
     &   (DBHMID(ICL).LT.DMAX(ISPSTO,IT)))THEN
