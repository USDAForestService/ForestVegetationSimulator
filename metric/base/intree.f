...
C       *** NOT SURE WHY OR WHEN THIS WAS IMPLEMENTED, BUT INPUT PLOT ID
C           DOES NOT MATCH OUTPUT PLOT ID HAS BEEN PROBLEM FOR SOME USERS.
C           THIS BEHAVIOR HAS BEEN SUPPRESSED. LRD 01/20/2022 
