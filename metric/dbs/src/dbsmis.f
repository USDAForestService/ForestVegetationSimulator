     ...
     -  KODE)
C----------
C  **DBSMIS1--DBS  DATE OF LAST REVISION:  10/27/10
C----------
C
...
C           COMPRESSED OR GENERATED THROUGH THE ESTAB SYSTEM.
     ...
     -        ' (Id,CaseID,StandID,Year,TreeID,Species,TPH,' //
...
C----------
C  **DBSMIS6--DBS  DATE OF LAST REVISION:  04/0/04
C----------
C
