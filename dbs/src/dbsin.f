...
C                        OPTION NUMBER 37 -- BMCMPTRL
      ...
      ENDIF
      ISPOUT37=0
      IF(ARRAY(2).GT.0) ISPOUT37 = ARRAY(2)
      IF(ISPOUT37.EQ.1)THEN
        CSPOUT='ALPHA'
      ELSEIF(ISPOUT37.EQ.2)THEN
        CSPOUT='FIA'
      ELSEIF(ISPOUT37.EQ.3)THEN
        CSPOUT='PLANTS'
      ELSE
        CSPOUT='NORMAL'
      ENDIF
      IF(LKECHO) WRITE(JOSTND,3710) KEYWRD
 3710 FORMAT(/A8,'   OUTPUT THE BIOMASS COMPONENT TREE LIST TABLE',A)
      GOTO 10
 3800 CONTINUE
C                        OPTION NUMBER 38 -- BMCMPCUT
      CALL FMLNKD(LACT)
      IF (LACT) THEN
        IFMBMCMPCUT = 1
      ENDIF
      I=1
      ISPOUT38=0
      IF(ARRAY(2).GT.0) ISPOUT38 = ARRAY(2)
      IF(ISPOUT38.EQ.1)THEN
        CSPOUT='ALPHA'
      ELSEIF(ISPOUT38.EQ.2)THEN
        CSPOUT='FIA'
      ELSEIF(ISPOUT38.EQ.3)THEN
        CSPOUT='PLANTS'
      ELSE
        CSPOUT='NORMAL'
      ENDIF
      IF(LKECHO) WRITE(JOSTND,3810) KEYWRD
 3810 FORMAT(/A8,'   OUTPUT THE BIOMASS COMPONENT CUT LIST TABLE',A)
      GOTO 10
C
