      ...
      IMPLICIT NONE
C----------
C   **FMCFMD FIRE-EC-DATE OF LAST REVISION: 01/20/05
C----------
...
C
     &  DFCT   =  1, ! Douglas-fir
     &  LPCT   =  2, ! lodgepole pine
     &  SAFCT  =  3, ! subalpine fir
     &  MHCT   =  4, ! mountain hemlock (other)
     &  WPCT   =  5, ! white pine
     &  ESCT   =  6, ! Engelmann spruce
     &  PSFCT  =  7, ! pacific silver fir
     &  WLCT   =  8, ! western larch
...
C
     ...
     &  LPWLCT = 12, ! lodgepole pine/western larch
C
C       DOG'S BREAKFAST
C
