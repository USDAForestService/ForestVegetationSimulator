      ...
      IMPLICIT NONE
C----------
C  **FMCROW  FIRE-SN DATE OF LAST REVISION:  03/06/2008
C----------
...
C----------
      ...
      REAL    D,H,SG,XV(0:5)
C----------
C  INDEX TO THE CROWN EQUATIONS USED.  EASTERN EQUATIONS ARE
C  BASED ON SN-FFE. AS A RESULT, IN THIS VARIANT EACH SPECIES MAPS
C  TO ITSELF.
C----------
...
C----------
        ...
        ENDDO
C
        CALL FMCROWE(SPI,SPI,ISEFOR,KODIST,D,H,IC,SG,XV)
C----------
