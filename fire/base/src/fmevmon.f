...
C
C      IF(DEBUG)WRITE(JOSTND,*)' ENTERING FMTREM,CYCLE=  ICYC,ITRNC,',
C     &'I,ISPC,DBH,DSNG1,SSNG1,CRREM,FMPROB(I),PREMST(I),',
C     &'PREMCR(I)= ',ICYC,ITRNC,I,ISP(I),DBH(I),DSNG1(I),
...
C
     ...
     &  'XHDBH,XLHT,XHHT,IRC= ',RVAL,ISTAND,ITYP,IPART,JX,XLDBH,
     &  XHDBH,XLHT,XHHT,IRC
        IF(DEBUG)WRITE(JOSTND,*)' ITRNC,SNGSRM,SNGCRN,LIVSRM,LIVCRM= ',
     &  ITRNC,SNGSRM,SNGCRN,LIVSRM,LIVCRM
C
      ENDIF      ! IFMYR1
C
      RETURN
