      ...
      IMPLICIT NONE
C---------- 
C  **DFTMOD DATE OF LAST REVISION:  06/30/10
C---------- 
C     
...
COMMONS     
C     
      INTEGER K,JODFEC,IGFCOD,IDFCOD,ITMREP,JOTMDK,JODFTM
      INTEGER ITMSLV,ITMSCH,IPRBMT,IZ6,ICOUNT,IC,KP
      INTEGER ITMETH,IBMTYP,NACLAS,NCLAS,IFIN,ISTART,I
      INTEGER K1,K2,IC1,IC2,K3,IC3,IX,JCLASS
      REAL Y1,F1,G1,R1,B1,Z1,X1,R0,B0,X0,TMPN1,TMASHD,TMPRB,TMDEFL,TOPO 
      REAL X7,X6,X5,Z3,Z2,Z5,Z4,G19OUT,DPCENT,CNTGF,CNTDF
      REAL PRBSCL,GFFBIO,DFFBIO,DFPNEW,WEIGHT,G3,G2,G19,GFPNEW    
C
