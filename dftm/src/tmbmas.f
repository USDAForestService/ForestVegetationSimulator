      ...
      IMPLICIT NONE
C---------- 
C  **TMBMAS DATE OF LAST REVISION:  06/30/10 
C---------- 
C     
...
COMMONS     
      ...
      INTEGER ITMSCH,IPRBMT,ITMETH,IBMTYP,NACLAS,NCLAS     
      INTEGER I,IS,IK,J,JODFEC,I1,I2
      REAL CR,DGI,FERROR,PERROR,TMBCHL,PCNEWF,FBIOMS,SCALDG
      REAL TMPN1,TMASHD,TMPRB,TMDEFL,TOPO,CNTGF,CNTDF
      REAL PRBSCL,GFFBIO,DFFBIO,GFPNEW,DFPNEW,WEIGHT
