      ...
      IMPLICIT NONE
C----------
C  **CRATET--OP   DATE OF LAST REVISION:  06/17/15
C----------
...
C----------
      ...
      INTEGER*4   IRAD
      INTEGER     NBIG6,NVALID,NLOAD,NUNLOAD,ORGFIA
...
C----------
      ...
      DO I = 1, IREC1
        IF(IORG(I) .EQ. 1)THEN
          ...
          IF(DEBUG)WRITE(JOSTND,*)
     &    ' KG,I,ITRE,ISP,DBH,HT,ICR,PROB,ISPECL,NUNLOAD= ',
     &    KG,I,ITRE(I),ISP(I),DBH(I),HT(I),ICR(I),PROB(I),
     &    ISPECL(I),NUNLOAD
        ENDIF
      ENDDO
