      ...
      IMPLICIT NONE
C----------
C  **MORTS--OP   DATE OF LAST REVISION:  04/06/15
C----------
...
C----------
      IF(DEBUG) THEN
        ...
        WRITE(JOSTND,9080) I,ISPC,D,P,WK2(I),PRES,VLOS
...
C----------
C**        TNEW=TNEW+P-WKI
C**        IF(.NOT.DEBUG) GO TO 1500
C**        PRES=P-WKI
C**        VLOS=WKI*CFV(I)/FINT
C**        WRITE(JOSTND,9080) I,ISPC,D,P,WKI,PRES,VLOS
 1500   CONTINUE
C----------
