      ...
      IMPLICIT NONE
C----------
C  **REGENT--OP   DATE OF LAST REVISION:  04/03/15
C----------
C  THIS SUBROUTINE COMPUTES 5-YR HEIGHT AND DIAMETER INCREMENTS FOR
C  SMALL TREES USING **SMHGDG** FROM THE WC VARIANT.  
C
C  FOR SPECIES/TREES USING FVS GROWTH EQUATIONS:
C    THE HEIGHT INCREMENT MODEL IS APPLIED TO TREES THAT ARE LESS THAN 4 
C    INCHES DBH (3.0" FOR LODGEPOLE PINE), AND THE DBH INCREMENT MODEL IS
C    APPLIED TO TREES THAT ARE LESS THAN 3 INCHES DBH.  FOR TREES THAT ARE
C    GREATER THAN 2 INCHES (1.0" FOR LODGEPOLE PINE)
C    AND LESS THAN 4 INCHES (3.0" FOR LODGEPOLE PINE) DBH, HEIGHT INCREMENT 
C    PREDICTIONS ARE AVERAGED WITH THE PREDICTIONS FROM THE LARGE TREE MODEL.
C    DIAMETER IS ASSIGNED EQUATIONS CONTAINED IN **SMHGDG**.
C
...
C----------
      ...
      REAL REGYR,FNT,SCALE,SCALE2,X,PCTRED,XRHGRO,XRDGRO
...
C----------
C  IF THIS IS A VALID ORGANON TREE, IORG(I)=1, DG WAS SET IN DGDRIV
C----------
      IF(IORG(I) .EQ. 1) GO TO 23
C
