      ...
      IMPLICIT NONE
C----------
C  **RPTWTR--PPBASE  DATE OF LAST REVISION:  07/31/08
C----------
C
...
C
      ...
      WRITE (JOPPRT,9003)
 9003 FORMAT(/)
      WRITE(JOPPRT,9004) AT1,ONTREM,(OSPTT(I),IOSPTT(I),I=1,4)
...
C
   40 CONTINUE
      WRITE (JOPPRT,9003)
      WRITE (JOPPRT,9006) AT4,OACC,(OSPAC(I),IOSPAC(I),I=1,4)
      IF (LMORT) THEN
...
C
   50 CONTINUE
      WRITE (JOPPRT,9003)
      WRITE (JOPPRT,9007) JYR,ONTCUR,(OSPCT(I),IOSPCT(I),I=1,4)
