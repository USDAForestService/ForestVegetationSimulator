      SUBROUTINE CH8SRT (N,A,INDEX,LSEQ)
      IMPLICIT NONE
C----------
C  **CH8SRT--PPBASE   DATE OF LAST REVISION:  07/31/08
C----------
C
C  CHARACTER*8 INDEX SORT.
C
C  CH8SRT USES THE VECTOR INDEX TO INDIRECTLY ADDRESS THE ARRAY A.
