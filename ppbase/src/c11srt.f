      SUBROUTINE C11SRT (N,A,INDEX,LSEQ)
      IMPLICIT NONE
C----------
C  **C11SRT DATE OF LAST REVISION:  07/31/08
C----------
C
C  CHARACTER*11 INDEX SORT.
C
C  C11SRT USES THE VECTOR INDEX TO INDIRECTLY ADDRESS THE ARRAY A.
