      ...
      IMPLICIT NONE
C----------
C  **GETSTD--PPBASE  DATE OF LAST REVISION: 07/21/11
C----------
C
C     READS A STAND FROM THE ALL DATA NUMERIC FILE, AND THE ALL
...
C
      INTEGER MXL,MXR,MXI,ILIMIT,IPNT,K,I,II
      INTEGER INTS(MXI)
...
C
C     GET THE FIRST RECORD FOR THIS STAND.
C
      IRDREC=ISNKEY(ISTND,2)
      IF (PDEBUG) WRITE (JOPPRT,'(/'' IN GETSTD: ISTND,IRDREC='',2I7)')
     >            ISTND,IRDREC
C
...
C
C     OPEN THE STAND DATA SET, AND GET THE INTEGER SCALARS.  IT IS
C     NECESSARY TO GET THE INTEGER SCALARS FIRST IN ORDER TO SET UP
