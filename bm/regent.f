      ...
      IMPLICIT NONE
C----------
C BM $Id: regent.f 0000 2018-02-14 00:00:00Z gedixon $
C----------
...
C----------
      ...
      CHARACTER SPEC*2
      INTEGER KK,ISPEC,KOUT,IPCCF,IREFI,N,I3,I
      INTEGER K,L,ITRNIN,NUMCAL(MAXSP),I1,I2,ISPC,JCR,INDX
      REAL SLO,SHI,AB(9),DGMAX(MAXSP),CCF,AVHT,X,HITE2
      REAL PCTRED,SI,DGMX,CR,VIGOR,TEMT,BX,AX,RELSI,RSIMOD,HITE1,AG2
      REAL CON,XMX,XMN,D,H,BARK,RAN,PPCCF,TPCCF,HLESS4
      REAL CRCODE,POTHTG,DLESS3,DDUM
      REAL HTGR,ZZRAN,XPPMLT,XWT,HK,DKK,DK,DDS,HTNEW,ALHT,ALHK
