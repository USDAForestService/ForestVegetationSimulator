...
C----------
      ...
      INTEGER K,KK,KOUT,L,N,IWHO,RDZ1
...
C ----------
      ...
      IF(DEBUG)WRITE(JOSTND,*) 'IN REGENT, CALL SDICLS - PT COUNT ',I2
      DO I1 = 1, I2
         CALL SDICLS (ISPC,DLO,DHI,IWHO,SDICS,SDICZ,A,B,I1)
         IF(DEBUG)WRITE(JOSTND,*) 'IN REGENT, PT ',I1,' SDICZ= ', SDICZ
         ZRD(I1) = SDICZ
      END DO
C----------
...
C     THAN 1 INCH (COMPUTE 10-YEAR DBH INCREMENT REGARDLESS OF
C     PROJECTION PERIOD LENGTH).
C----------
      IF(D.GE.1.0) GO TO 23
      HK=H + HTG(K)
...
C----------
      ...
      IF(DBH(I).GE.1.0.OR.H.LT.0.01) GO TO 60
      EDH = 0.
      SELECT CASE(ISPC)
C----------
C  CALCULATE HIEGHT GROWTH FOR BOREAL SPECIES 
