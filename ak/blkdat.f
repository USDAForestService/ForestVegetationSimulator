...
C  HTT* and HTT** USED IN THE HEIGHT DUBBING FUNCTIONS.
     ...
     & 57.4906, 74.8099, 157.182, 157.182, 74.8089/
      DATA (HTT12(I,J),I=1,MAXSP)/23*0.04469/
      DATA (HTT13(I,J),I=1,MAXSP)/23*0.04803/
      DATA (HTT14(I,J),I=1,MAXSP)/
