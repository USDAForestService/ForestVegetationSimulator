...
C----------
      ...
      INTEGER NOTE(99),JNULL(MAXSP),MAXTPP2(14),MAXING2(14)
      INTEGER MAXSPP2(14)
...
C----------
     ...
     &  MAXTPP2/27,39,19,32,31,32,32,19,17,25,25,17,21,0/,
     &  MAXSPP2/2,2,3,4,4,3,4,2,2,2,2,2,2,0/,
     &  MAXING2/14,20,10,16,16,16,16,10,8,12,12,8,10,0/
C----------
C STEP 1: INITIALIZE ARRAYS AND VARIABLES, AN REPLICATE PLOTS
C----------
