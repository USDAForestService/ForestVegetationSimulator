...
C
C MAXSPP: CONTAINS THE 95TH PERCENTILE OF NUMBER OF SPECIES THAT CAN
C OCCUR ON A STOCKED PLOT BY FOREST TYPE.
C
C MAXING: CONTAINS TPP VALUES USED IN INGROWTH PREDICTIONS BY FOREST
...
C THESE VALUES YIELDED INGROWTH VALUES THAT SEEMED TO HIGH.
C-----------
      DATA
     &  MAXTPP/30,44,16,31,29,36,31,16,24,24,25,30,12,0/,
