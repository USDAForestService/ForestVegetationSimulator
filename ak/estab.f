...
C----------
     ...
     & NOFSPE/MAXSP/
      ...
      DATA
     &  MAXTPP/27,39,19,32,31,32,32,19,17,25,25,17,21,0/,
     &  MYHABG/4*1,4*2,3,4,6*5/,
     &  MAXSPP/2,2,3,4,4,3,4,2,2,2,2,2,2,0/,
     &  MAXING/14,20,10,16,16,16,16,10,8,12,12,8,10,0/
...
C----------
      CALL ESRANN (DRAW)
      IF(DRAW .GT. 0.75) DRAW=0.75
      IF(DEBUG) WRITE(JOSTND, *) ' DRAW AFTER ESRANN=', DRAW
