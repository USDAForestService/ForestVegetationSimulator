      SUBROUTINE DUBSCR(ISPC,D,H,RDEN,CR)
      IMPLICIT NONE
C----------
C AK $Id$
C----------
...
C
      INTEGER ISPC
C
      REAL BACHLO,CR,D,FCR,H,RDANUW,SD,RDEN
C
      REAL CRSD(MAXSP)
C----------
C  DATA STATEMENTS:
...
C    STANDARD ERROR OF REGRESSIONS FOR EACH SPECIES
     DATA CRSD/
     &  0.1752,0.1752,0.1631,0.1647,0.1537,
     &  0.1537,0.1894,0.1752,0.1583,0.207,
     &  0.1751,0.1643,0.1537,0.1531,0.1531,
     &  0.1439,0.1439,0.1245,0.1354,0.1575,
     &  0.1818,0.1818,0.1575/
C
C-----------
C  CHECK FOR DEBUG.
C-----------
