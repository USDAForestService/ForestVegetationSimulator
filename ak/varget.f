...
C
      ...
      CALL BFREAD (WK3, IPNT, ILIMIT, NOPERMH1,  MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, NOPERMH2,  MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, NOPERMH3,  MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, NOPERMH4,  MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, NOPERMH5,  MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, NOPERMH6,  MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, NOPERMH7,  MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, PERMH1,    MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, PERMH2,    MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, PERMH3,    MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, PERMH4,    MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, PERMH5,    MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, PERMH6,    MAXSP,    2)
      CALL BFREAD (WK3, IPNT, ILIMIT, PERMH7,    MAXSP,    2)
