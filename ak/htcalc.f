...
CC      REAL POTHTG,XSITE,RDZ,ZRD(MAXPLT),CRAT,ELEVATN,XMAX
      REAL POTHTG,XSITE,CRAT,ELEVATN
cc      REAL DLO,DHI,SDIC,SDIC2,A,B,AX,BX,CX,DX,EX,FX,PBAL
      REAL B1, B2, B3, B4, B5, B6, PBAL, DG10
...
C TO HELP CERTAIN SPECIES HIT SITE INDEX.
      DATA HGMLT/
     &     1.00, 1.00, 1.60, 1.00, 1.00, 1.00, 1.00, 1.00, 1.60, 1.30,
     &     1.15, 1.50, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00,
     &     1.00, 1.00, 1.00/
C-----------
