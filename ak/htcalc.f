...
C A 100 YEAR PLANTING SIMULATION. PAPER BIRCH HEIGHT GROWTH WAS REDUCED 
C AS IT WAS OBSERVED TO BE TOO HIGH WHEN EXAMINING PREDICTED VERSUS 
C OBSERVED HEIGHTS.

      DATA HGMLT/
     &     0.95, 0.95, 1.50, 1.00, 1.00, 1.00, 1.00, 0.95, 1.50, 1.30,
     &     1.15, 1.35, 1.00, 1.00, 1.00, 0.90, 0.90, 1.00, 0.90, 1.00,
     &     1.00, 1.00, 1.00/
