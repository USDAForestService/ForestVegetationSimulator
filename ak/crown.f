...
C
      ...
      INTEGER ISPCC,IULIM,J1,JJ,NP,NTODO,IWHO,PI
      INTEGER ISORT(MAXTRE),MYACTS(1)
C
      REAL CHG,CL,CR,CRLN,CRMAX,D,H,HD,HN,PDIFPY
      REAL RDEN,DLO,DHI,SDICS,SDICZ,A,B,RNUMB,X,B1,B2,B3,B4,B5
      REAL CRNEW(MAXTRE),PRM(5),ZRD(MAXPLT)
C
C----------
C  DATA STATEMENTS:
C----------
...
C  DETERMINE IF DEBUG IS NEEDED
     ...
     &  B1,B2,B3,B4,B5,SDIDEF(ISPC)
 9001 FORMAT(' IN CROWN 9001 ISPC,SDIAC,ORMSQD,RELSDI,',
     &  'B1,B2,B3,B4,B5,SDIDEF = ',/1X,I5,F8.2,F8.2,F8.2,6F10.4)
C
