...
C
      ...
      REAL RNUMB,X,B1,B2,B3,B4,B5
      REAL CRNEW(MAXTRE),PRM(5)
C
C----------
C  DATA STATEMENTS:
C----------
...
C  DETERMINE IF DEBUG IS NEEDED
      ...
      & ACRNEW,B1,B2,B3,B4,B5,SDIDEF(ISPC)
      9001 FORMAT(' IN CROWN 9001 WRITE ISPC,SDIAC,ORMSQD,RELSDI,
...
C  INTERCEPT COEFFICIENTS
      ...
      &          -3.843318, -2.440594, -2.861215, -0.66164, -0.431654, 
      &          -0.815858, -0.440982, -3.843318, -2.95449, -2.95449,
...
C  HT/DBH RATIO COEFFICIENTS
      ...
      &          0.16423, 0.111255, 0.610051, 0.71494, 0.71494,
      &          0.126382, 0.126382, -0.110829, -0.19024, -0.379692,
...
C  RELATIVE DENSITY COEFFICIENTS
      ...
      &         1.19371, 1.19371, 0.454976, 1.070486, 1.02542,
