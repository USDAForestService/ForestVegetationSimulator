      ...
      IMPLICIT NONE
C----------
C ESTB $Id: esnutr.f 2862 2019-11-19 13:41:38Z ckeyser01 $
C----------
C
C     INTERFACE ROUTINE TO COUPLE THE REGEN MODEL AND PROGNOSIS.
C
C  MODIFIED FOR ALASKA TO MAKE AUTOESTAB KICK IN
C  EVERY 50 YEARS INSTEAD OF EVERY 20 (ANTOS ET AL,2000)
C----------
C
COMMONS
C
