...
C  8112 = QUILEUTE RES.        (MAPPED TO 701 MAKAH RES.ERVATION)
C  7840 = HOOPER BAY ANVSA     (MAPPED TO 1004 CHUGACH)
C  7404 = SELAWIK ANVSA        (MAPPED TO 1004 CHUGACH)
C  7403 = NANWALEK ANVSA       (MAPPED TO 1004 CHUGACH)
C  7402 = KONGIGANAK ANVSA     (MAPPED TO 1004 CHUGACH)
...
C       CROSSWALK FOR RESERVATION PSUEDO CODES & LOCATION CODE
        CASE (8135)
          WRITE(JOSTND,61)
   61     FORMAT(T12,'MAKAH INDIAN RES. (8135) BEING MAPPED TO ',
     &    'MAKAH INDIAN RES. (701) FOR FURTHER PROCESSING.')
          IFOR = 4
        CASE (8134)
          WRITE(JOSTND,62)
   62     FORMAT(T12,'ANNETTE ISLAND (8134) BEING MAPPED TO ',
     &    'TONGASS - STIKINE AREA (1002) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (8112)
          WRITE(JOSTND,63)
   63     FORMAT(T12,'QUILEUTE RES. (8112) BEING MAPPED TO ',
     &    'MAKAH RES.ERVATION (701) FOR FURTHER PROCESSING.')
          IFOR = 4
        CASE (7840)
          WRITE(JOSTND,64)
   64     FORMAT(T12,'HOOPER BAY ANVSA (7840) BEING ',
     &    'MAPPED TO CHUGACH (1004) FOR FURTHER PROCESSING.')
          IFOR = 5
        CASE (7404)
          WRITE(JOSTND,65)
   65     FORMAT(T12,'SELAWIK ANVSA (7404) BEING ',
     &    'MAPPED TO CHUGACH (1004) FOR FURTHER PROCESSING.')
          IFOR = 5
        CASE (7403)
          WRITE(JOSTND,66)
   66     FORMAT(T12,'NANWALEK ANVSA (7403) BEING ',
     &    'MAPPED TO CHUGACH (1004) FOR FURTHER PROCESSING.')
          IFOR = 5
        CASE (7402)
          WRITE(JOSTND,67)
   67     FORMAT(T12,'KONGIGANAK ANVSA (7402) BEING ',
     &    'MAPPED TO CHUGACH (1004) FOR FURTHER PROCESSING.')
          IFOR = 5
        CASE (7401)
          WRITE(JOSTND,68)
   68     FORMAT(T12,'ARCTIC VILLAGE ANVSA (7401) BEING ',
     &    'MAPPED TO CHUGACH (1004) FOR FURTHER PROCESSING.')
          IFOR = 5
