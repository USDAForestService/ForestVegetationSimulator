...
C
   ...
   20 CONTINUE
      IF(I .EQ. 7)THEN
        WRITE(JOSTND,21)
   21   FORMAT(T13,'ANGELES NF (501) BEING MAPPED TO SEQUOIA ',
     &  '(513) FOR FURTHER PROCESSING.')
        I=3
      ELSEIF(I .EQ. 8)THEN
        WRITE(JOSTND,22)
   22   FORMAT(T13,'CLEVELAND NF (502) BEING MAPPED TO SEQUOIA ',
     &  '(513) FOR FURTHER PROCESSING.')
        I=3
      ELSEIF(I .EQ. 9)THEN
        WRITE(JOSTND,23)
   23   FORMAT(T13,'INYO NF (504) BEING MAPPED TO SEQUOIA ',
     &  '(513) FOR FURTHER PROCESSING.')
        I=3
      ELSEIF(I .EQ. 10)THEN
        WRITE(JOSTND,24)
   24   FORMAT(T13,'LOS PADRES NF (507) BEING MAPPED TO SEQUOIA ',
     &  '(513) FOR FURTHER PROCESSING.')
        I=3
      ELSEIF(I .EQ. 11)THEN
        WRITE(JOSTND,25)
   25   FORMAT(T13,'SAN BERNARDINO NF (512) BEING MAPPED TO SEQUOIA ',
     &  '(513) FOR FURTHER PROCESSING.')
        I=3
      ELSEIF(I .EQ. 12)THEN
        WRITE(JOSTND,26)
   26   FORMAT(T13,'LAKE TAHOE BASIN MGMT UNIT (519) BEING MAPPED TO ',
     &  'ELDORADO (503) FOR FURTHER PROCESSING.')
        I=1
      ELSEIF(I .EQ. 13)THEN
        WRITE(JOSTND,27)
   27   FORMAT(T13,'TOIYABE NF (417) BEING MAPPED TO STANISLAUS ',
