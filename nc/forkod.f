...
C  7840 = HOOPA VALLEY RES                 (MAPPED TO 705 HOOPA RES)
...
C       CROSSWALK FOR RESERVATION PSUEDO CODES & LOCATION CODE
        CASE (7806)
          WRITE(JOSTND,60)
   60     FORMAT(T12,'DRY CREEK RANCHERIA (7806) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7807)
          WRITE(JOSTND,61)
   61     FORMAT(T12,'ROBINSON RANCHERIA (7807) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7810)
          WRITE(JOSTND,62)
   62     FORMAT(T12,'HOPLAND RANCHERIA (7810) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7813)
          WRITE(JOSTND,63)
   63     FORMAT(T12,'LAYTONVILLE RANCHERIA (7813) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7815)
          WRITE(JOSTND,64)
   64     FORMAT(T12,'MANCHESTER-PT. ARENA RANCHERIA (7815) BEING ',
     &    'MAPPED TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7816)
          WRITE(JOSTND,65)
   65     FORMAT(T12,'MIDDLETOWN RANCHERIA (7816) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7820)
          WRITE(JOSTND,66)
   66     FORMAT(T12,'REDWOOD VALLEY RANCHERIA (7820) BEING ',
     &    'MAPPED TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7821)
          WRITE(JOSTND,67)
   67     FORMAT(T12,'ROUND VALLEY OFF-RES. TRUST LAND (7821) BEING ',
     &    'MAPPED TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7824)
          WRITE(JOSTND,68)
   68     FORMAT(T12,'STEWARTS POINT RANCHERIA (7824) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7830)
          WRITE(JOSTND,69)
   69     FORMAT(T12,'SHERWOOD VALLEY RANCHERIA (7830) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7831)
          WRITE(JOSTND,70)
   70     FORMAT(T12,'SULPHUR BANK RANCHERIA (7831) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7833)
          WRITE(JOSTND,71)
   71     FORMAT(T12,'UPPER LAKE RANCHERIA (7833) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7834)
          WRITE(JOSTND,72)
   72     FORMAT(T12,'COYOTE VALLEY RESERVATION (7834) BEING MAPPED ',
     &    'TO MENDOCINO NF (508) FOR FURTHER PROCESSING.')
           IFOR = 10
        CASE (7839)
          WRITE(JOSTND,73)
   73     FORMAT(T12,'ELK VALLEY OFF-RES. TRUST LAND (7839) BEING ',
     &    'MAPPED TO SIX RIVERS NF (510) FOR FURTHER PROCESSING.')
           IFOR = 2
        CASE (7840)
          WRITE(JOSTND,74)
   74     FORMAT(T12,'HOOPA VALLEY RES (7840) BEING MAPPED ',
     &    'TO HOOPA RES (705) FOR FURTHER PROCESSING.')
           IFOR = 5
        CASE (7841)
          WRITE(JOSTND,75)
   75     FORMAT(T12,'YUROK RESERVATION (7841) BEING MAPPED ',
     &    'TO SIX RIVERS NF (510) FOR FURTHER PROCESSING.')
           IFOR = 2
        CASE (7843)
          WRITE(JOSTND,76)
   76     FORMAT(T12,'TRINIDAD RANCHERIA (7843) BEING MAPPED ',
     &    'TO SIX RIVERS NF (510) FOR FURTHER PROCESSING.')
           IFOR = 2
        CASE (7845)
          WRITE(JOSTND,77)
   77     FORMAT(T12,'KARUK OFF-RES. TRUST LAND (7845) BEING ',
     &    'MAPPED TO KLAMATH NF (505) FOR FURTHER PROCESSING.')
           IFOR = 1
        CASE (8103)
          WRITE(JOSTND,78)
   78     FORMAT(T12,'COOS, LOWER UMPQUA, SIUSLAW RES. (8103) BEING ',
     &    'MAPPED TO SISKIYOU NF (611) FOR FURTHER PROCESSING.')
           IFOR = 4
        CASE (8105)
          WRITE(JOSTND,79)
   79     FORMAT(T12,'COQUILLE RESERVATION (8105) BEING MAPPED ',
     &    'TO SISKIYOU NF (611) FOR FURTHER PROCESSING.')
           IFOR = 4
