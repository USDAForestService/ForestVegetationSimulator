      ...
      IMPLICIT NONE
C----------
C  **BLKDAT--CS  DATE OF LAST REVISION: 09/08/11
C----------
C
...
C
     ...
     & '827',   '828',   '831',   '834',   '999',   '931',   '331',
     & '450',   '521',   '552',   '741',   '743',   '746',   '901',
     & '999',   '731',   '221',   '373',   '611',   '920',   '922',
     & '999',   '391',   '471',   '491',   '500',   '571',   '641',
     & '651',   '653',   '680',   '701',   '711'/
C
      DATA PLNJSP /
     &'JUVI  ','JUNIP ','PIEC2 ','PIVI2 ','PITA  ','2TE   ','PIST  ',
     &'JUNI  ','JUCI  ','NYSSA ','NYBI  ','NYAQ2 ','NYSY  ','CARYA ',
     ...
     &'QUNI  ','QUNU  ','QUPH  ','QUSH  ','2TREE ','SAAL5 ','AEGL  ',
     &'CATAL ','DIVI5 ','GLTR  ','POBA2 ','POGR4 ','POTR5 ','ROPS  ',
     &'2TREE ','PLOC  ','TADI2 ','BENI  ','LIST2 ','SALIX ','SANI  ',
     &'2TREE ','CACA18','CECA4 ','COFL2 ','CRATA ','GYDI  ','MAPO  ',
