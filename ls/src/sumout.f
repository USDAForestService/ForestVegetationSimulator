...
C
    ...
    5 FORMAT(/' STAND ID: ',A26,4X,'MGMT ID: ',A4,4X,A/)
      WRITE (JOSTND,10)
   10 FORMAT(//33X,'SUMMARY STATISTICS (PER ACRE OR STAND BASED ON TOTAL
     & STAND AREA)',/,1X,
     &  127(1H-),/16X,'START OF SIMULATION PERIOD',21X,'REMOVALS',13X,
     &  'AFTER TREATMENT',4X,'GROWTH THIS PERIOD',/10X,45(1H-),1X,
     &  23(1H-),1X,21(1H-),2X,18(1H-),3X,'MAI',/10X,'NO OF',14X,'TOP',
     &  6X,'MERCH SAWLG SAWLG NO OF MERCH SAWLG SAWLG',14X,'TOP  RES  ',
     &  'PERIOD ACCRE MORT   MERCH',/1X,'YEAR AGE TREES  BA  SDI CCF ',
     &  'HT  QMD  CU FT CU FT BD FT TREES CU FT CU FT BD FT  BA  SDI ',
     &  'CCF HT   QMD  YEARS   PER  YEAR   CU FT',/1X,'---- --- ----- ',
     &  '--- ---- --- --- ---- ',7('----- '),'--- ---- --- --- ----  ',
     &  '------ ---- -----   -----')
      ENDIF
C
...
C----------
   ...
   20     FORMAT(1X,2I4,I6,I4,I5,2I4,F5.1,7I6,I4,I5,2I4,F5.1,2X,
     &           I6,I5,I6,2X,F6.1)
C
      IF(LDSK)
