...
C
     ...
     &  CTYPE,UPSHT1,TLOGS,NUMLOGP,NUMLOGS)
C
...
C
     ...
     &    I01,I1,PROD,IERR,CTYPE,UPSHT1,TLOGS,NUMLOGP,NUMLOGS)
C
...
C
     ...
     &         I1,PROD,IERR,CTYPE,UPSHT1,TLOGS,NUMLOGP,NUMLOGS)
          IF((KODFOR.EQ.902).OR.(KODFOR.EQ.903).OR.(KODFOR.EQ.906).OR.
     &      (KODFOR.EQ.907).OR.(KODFOR.EQ.909).OR.(KODFOR.EQ.910).OR.
     &      (KODFOR.EQ.913))THEN
            SAWBF=VOL(2)
...
C
     ...
     &    PROD,IERR,CTYPE,UPSHT1,TLOGS,NUMLOGP,NUMLOGS)
C
...
C
     ...
     &    IERR,CTYPE,UPSHT1,TLOGS,NUMLOGP,NUMLOGS)
          IF((KODFOR.EQ.902).OR.(KODFOR.EQ.903).OR.(KODFOR.EQ.906).OR.
     &      (KODFOR.EQ.907).OR.(KODFOR.EQ.909).OR.(KODFOR.EQ.910).OR.
     &      (KODFOR.EQ.913))THEN
            SAWBF=VOL(2)
