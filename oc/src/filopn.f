      ...
      IMPLICIT NONE
C--------
C  **FILOPN--BASE   DATE OF LAST REVISION:  07/23/08C
C $Id: filopn.f 271 2012-11-14 22:17:42Z jdh $
C $Revision: 271 $
C $Date: 2012-11-14 14:17:42 -0800 (Wed, 14 Nov 2012) $
C $HeadURL: https://www.forestinformatics.com/svn/fvs/trunk/cacor/src/filopn.f $
C ----------
C
...
C----------
 ...
 1         FORMAT(/T20,'CR FVS VARIANT -- RV:',A10/)
        ELSE
           WRITE(*,2) VVER(:2),REV
C----------
C  ORGANON: Append "BETA" to the header
C----------
 2         FORMAT(/T20,A2,' FVS VARIANT BETA - RV:',A10/)
        ENDIF
C     
