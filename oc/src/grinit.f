...
C----------
      ...
      LORGVOLS  = .TRUE.        ! THE VOLUME DLL IS BEING USED.
...
C     TODO: THESE NEED TO BE CONVERTED UPDATED FROM FVS.
C
      DO I=1,18
         ACALIB(1,I)  = 1.0 
         ACALIB(2,I)  = 1.0
...
C
      ...
      BLMMIND=6.0            ! MINIMUM DBH FOR BLM VOLUMES
      BLMRA=511              ! BLM RESOURCE AREA FOR BLM VOLUMES
      ORGVEQ=0               ! USE OSU EQUATIONS
C
