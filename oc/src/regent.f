...
C  START ORGANON
C
C  HEIGHTS FOR ALL TREES WAS DONE IN HTGF; DIAMETERS IN DGDRIV/DGF. 
C  FOR NOW JUST SKIP THIS ROUTINE  ----DIXON.
C
      IF(.NOT. LSTART)GO TO 91 
C
C  END ORGANON
C----------
C----------
...
C
      DO I=1,ITRN
      WRITE(JOSTND,*)' REGENT ORG I,ISP,DBH,DG,HT,HTG= ',
