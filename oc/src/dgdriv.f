      ...
      IMPLICIT NONE
C----------
C CA $Id: dgdriv.f 1146 2014-02-06 16:44:38Z rhavis@msn.com $
C----------
...
C    DBH    DBH >= 0.1 INCH
C IF NOT A VALID ORGANON TREE, SET SURROGATE SPECIES FROM ARRAY OSPMAP 
C SO ORGANON GETS STAND DENSITIES CORRECT, BUT USE FVS GROWTH ESTIMATES
C FOR THESE TREES.
C
...
C
      INDS(4)=1   !0=UNEVEN-AGED, 1=EVEN-AGED
C      INDS(7)=1   !0=NO THINNING, 1=STAND THINNED
C      INDS(11)=1  !0=NO OVERSTORY REMOVAL, 1 = OVERSTORY REMOVAL
