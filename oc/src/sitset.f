...
C
C SETTING FOR SPECIES 15 AND 16 IS FROM THE ORGANON CODE
C----------
      IF(DEBUG)WRITE(JOSTND,*)' IN SITSET BEFORE ORG SITE EQNS SP 15 &',
     &' 16 SITE INDEX = ',SITEAR(15),SITEAR(16)
      ...
      ENDIF
      IF(DEBUG)WRITE(JOSTND,*)' IN SITSET AFTER ORG SITE EQNS SP 15 &',
     &' 16 SITE INDEX = ',SITEAR(15),SITEAR(16)
C
      DO 35 I=1,MAXSP
      IF(IFOR .GE. 6) THEN
