...
C         DO Z = 1, 5
C            IF( ORGVOL_TERROR(Z) .EQ. 1 .OR. 
C     &           ORGVOL_VERROR(Z) .eq. 1 ) THEN
C               IF (DEBUG) WRITE(JOSTND,14) ICYC, I, ORGVOL_VERROR(Z), 
C     &                                       ORGVOL_VWARNING(Z)
C   14          FORMAT(' CALLING ORGANON DLL::VOLCAL::BETA, CYCLE=',I2,
C     &              ' IDX=',I2, 
C     &              ' VERROR=',I2, 
C     &              ' VWARNING=',I2 )
C            END IF
