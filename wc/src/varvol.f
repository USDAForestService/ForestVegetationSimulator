...
C
          IF(DEBUG)WRITE(16,*)' AFTER BLMVOL-VEQNNC(ISPC),v',
     &    'H,X0,D,F,IFC,TVOL,LOGDIA, LOGLEN,LOGVOL,LOGST,NLOGMS,NLOGTW',
     &    '= ',VEQNNB(ISPC),TOPDIB,H,X0,D,'F',IFC,TVOL,LOGDIA,
...
C
     ...
     &      BFTOPD(ISPC),BARK
C    
            CALL BLMVOL(VEQNNB(ISPC),TOPDIB,H,X0,D,'F',IFC,TVOL,
...
C
     ...
     &      'LOGST,NLOGMS,NLOGTW= ',VEQNNB(ISPC),TOPDIB,H,
