        ...
        IMPLICIT NONE
C----------
C  **VARVOL--WC    DATE OF LAST REVISION:   08/05/11
C----------
C
...
C      DATA GIPEQN/MAXSP*'632BEHW000'/
C      DATA MBSEQN/MAXSP*'632BEHW000'/
C      DATA MTHEQN/MAXSP*'632BEHW000'/
C      DATA ROREQN/MAXSP*'632BEHW000'/
C      DATA UMPEQN/MAXSP*'632BEHW000'/
C      DATA WILEQN/MAXSP*'632BEHW000'/
C
C      DATA BLMEQN/
...
C     &'B02BEHW202','B00BEHW211','B00BEHW242','B00BEHW260','B00BEHW260',
...
C
     ...
     &    'APC= ',VEQNNB(ISPC),TOPD(ISPC),H,X0,D,'F',IFC,TVOL,LOGDIA,
     &                  LOGLEN,LOGVOL,LOGST,NLOGMS,NLOGTW,APC
