      ...
      IMPLICIT NONE
C----------
C  **HTDBH--WC  DATE OF LAST REVISION:  05/19/08
C----------
...
C            10 IS BLM MEDFORD/LAKEVIEW --- USE ROGUE RIVER
...
C    8 = CHNO     ALASKA YELLOW CEDAR       CHAMAECYPARIS NOOTKATENSIS
...
C   25 = CACH6    GIANT CHINKAPIN           CASTANOPSIS CHRYSOPHYLLA
