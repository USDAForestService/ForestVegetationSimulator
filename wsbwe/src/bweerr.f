      ...
      IMPLICIT NONE
C----------
C  **BWEERR                 DATE OF LAST REVISION:  07/14/10
C----------
C
...
C                        ERROR NUMBER 1
 ...
 1110 FORMAT (/,A12,'BWM01 ERROR:  INVALID KEYWORD WAS SPECIFIED. ',
...
C                        ERROR NUMBER 2
 ...
 1210 FORMAT (/,A12,'BWM02 ERROR:  END-OF-FILE REACHED WHEN IT WAS ',
...
C                        ERROR NUMBER 3
 ...
 1310 FORMAT (/A12,'BWM03 ERROR:  NO STANDS TO PROJECT.')
 1400 CONTINUE
C                        ERROR NUMBER 4
      WRITE (JOSTND,1410) PREF,DSRN,IREAD,IRECNT
 1410 FORMAT (/,A12,'BWM04 ERROR:  A REQUIRED PARAMETER IS MISSING',
...
C                        ERROR NUMBER 6
 ...
 1610 FORMAT (/,A12,'BWM06 ERROR:  COLUMN 1 OF KEYWORD RECORD BLANK.  ',
     >        A28,I3,' RECORDS READ =',I5)
      IF (ICCODE .LT. 2) ICCODE=2
      GOTO 9000
 1700 CONTINUE
C                        ERROR NUMBER 7
      WRITE (JOSTND,1710) PREF
 1710 FORMAT (/A12,'BWM07 ERROR:  TOO MANY STANDS.')
      GOTO 9000
 1800 CONTINUE
C                        ERROR NUMBER 8
      WRITE (JOSTND,1810) PREF
 1810 FORMAT (/A12,'BWM08 ERROR:  DUPLICATE READFOL STAND-IDS ',
...
C                        ERROR NUMBER 9
 ...
 1910 FORMAT (/A12,'BWM09 ERROR:  STNDLOC RECORD NOT FOUND FOR ',
...
C                     ERROR NUMBER 10
 ...
 2010 FORMAT(/A12,'BWM10 ERROR:  END OF MEMORY IN STAND HOLDING AREA.')
      GOTO 9000
 2100 CONTINUE
C                     ERROR NUMBER 11
      WRITE (JOSTND,2110) PREF
      ICCODE=0
 2110 FORMAT (/A12,'BWM11 ERROR:  STARTING YEAR GREATER THAN ',
     >             'ENDING YEAR.')
 9000 CONTINUE
C
