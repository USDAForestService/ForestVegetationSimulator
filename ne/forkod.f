...
C       CROSSWALK FOR RESERVATION PSUEDO CODES & LOCATION CODE
        CASE (8200)
          WRITE(JOSTND,60)
   60     FORMAT(T12,'PASSAMAQUODDY RESERVATION (8200) BEING ',
     &    'MAPPED TO WHITE MOUNTAIN NF (922) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (8201)
          WRITE(JOSTND,61)
   61     FORMAT(T12,'PENOBSCOT OFF-RESERVATION TL (8201) BEING ',
     &    'MAPPED TO WHITE MOUNTAIN NF (922) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (8202)
          WRITE(JOSTND,62)
   62     FORMAT(T12,'HOULTON MALISEET RESERVATION (8202) BEING ',
     &    'MAPPED TO WHITE MOUNTAIN NF (922) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (8203)
          WRITE(JOSTND,63)
   63     FORMAT(T12,'MASHANTUCKET PEQUOT RES (8203) BEING ',
     &    'MAPPED TO WHITE MOUNTAIN NF (922) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (8204)
          WRITE(JOSTND,64)
   64     FORMAT(T12,'PAUCATUCK EASTERN PEQUOT RES (8204) BEING ',
     &    'MAPPED TO WHITE MOUNTAIN NF (922) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (8206)
          WRITE(JOSTND,65)
   65     FORMAT(T12,'NARRAGANSETT RESERVATION (8206) BEING ',
     &    'MAPPED TO WHITE MOUNTAIN NF (922) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (8208)
          WRITE(JOSTND,66)
   66     FORMAT(T12,'WAMPANOAG-AQUINNAH TL (8208) BEING ',
     &    'MAPPED TO WHITE MOUNTAIN NF (922) FOR FURTHER PROCESSING.')
        ...
        CASE (8209)
          WRITE(JOSTND,67)
   67     FORMAT(T12,'AROOSTOOK BAND OF MICMAC TL (8209) BEING ',
     &    'MAPPED TO WHITE MOUNTAIN NF (922) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (8211)
          WRITE(JOSTND,68)
   ...
   69     FORMAT(T12,'CAYUGA NATION TDSA (8214) BEING ',
     &    'MAPPED TO FINGER LAKES NF (930) FOR FURTHER PROCESSING.')
        ...
        CASE (8215)
          WRITE(JOSTND,70)
   70     FORMAT(T12,'ONONDAGA NATION RESERVATION (8215) BEING ',
     &    'MAPPED TO FINGER LAKES NF (930) FOR FURTHER PROCESSING.')
          IFOR = 7
        CASE (8216)
          WRITE(JOSTND,71)
   71     FORMAT(T12,'TONAWANDA RESERVATION (8216) BEING ',
     &    'MAPPED TO FINGER LAKES NF (930) FOR FURTHER PROCESSING.')
        ...
        CASE (8217)
          WRITE(JOSTND,72)
   72     FORMAT(T12,'TUSCARORA NATION RESERVATION (8217) BEING ',
     &    'MAPPED TO FINGER LAKES NF (930) FOR FURTHER PROCESSING.')
          IFOR = 7
        CASE (8218)
          WRITE(JOSTND,73)
   73     FORMAT(T12,'ONEIDA NATION RESERVATION (8218) BEING ',
     &    'MAPPED TO FINGER LAKES NF (930) FOR FURTHER PROCESSING.')
          IFOR = 7
