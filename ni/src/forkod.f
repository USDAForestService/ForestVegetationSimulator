...
C
      IF(I .EQ. 12)THEN
        WRITE(JOSTND,22)
   22   FORMAT(T13,'KANIKSU NF (613) BEING MAPPED TO ',
     &  'KANIKSU (113) FOR FURTHER PROCESSING.')
        I=7
      ELSEIF(I .EQ. 13)THEN
        WRITE(JOSTND,24)
   24   FORMAT(T13,'BEAVERHEAD (102) BEING MAPPED TO ',
     &  'BITTERROOT (103) FOR FURTHER PROCESSING.')
        I=1
      ELSEIF(I .EQ. 14)THEN
        WRITE(JOSTND,26)
   26   FORMAT(T13,'DEERLODGE (109) BEING MAPPED TO ',
     &  'BITTERROOT (103) FOR FURTHER PROCESSING.')
        I=1
      ELSEIF(I .EQ. 15)THEN
        WRITE(JOSTND,28)
   28   FORMAT(T13,'HELENA (112) BEING MAPPED TO ',
