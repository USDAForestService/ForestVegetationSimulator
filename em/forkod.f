...
C       CROSSWALK FOR RESERVATION PSUEDO CODES & LOCATION CODE
        CASE (7101)
          WRITE(JOSTND,61)
   61     FORMAT(T12,'CHEYENNE RIVER RESERVATION (7101) BEING ',
     &    'MAPPED TO CUSTER NF (108) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (7102)
          WRITE(JOSTND,62)
   62     FORMAT(T12,'FORT BERTHOLD RESERVATION (7102) BEING MAPPED ',
     &    'TO CUSTER NF (108) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (7103)
          WRITE(JOSTND,63)
   63     FORMAT(T12,'SPIRIT LAKE RESERVATION (7103) BEING MAPPED ',
     &    'TO CUSTER NF (108) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (7107)
          WRITE(JOSTND,64)
   64     FORMAT(T12,'LAKE TRAVERSE RESERVATION (7107) BEING MAPPED ',
     &    'TO CUSTER NF (108) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (7108)
          WRITE(JOSTND,65)
   65     FORMAT(T12,'STANDING ROCK RESERVATION (7108) BEING MAPPED ',
     &    'TO CUSTER NF (108) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (7109)
          WRITE(JOSTND,66)
   66     FORMAT(T12,'TURTLE MOUNTAIN OFF-RES. LAND (7109) BEING ',
     &    'MAPPED TO CUSTER NF (108) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (7301)
          WRITE(JOSTND,67)
   67     FORMAT(T12,'BLACKFEET INDIAN RESERVATION (7301) BEING ',
     &    'MAPPED TO LEWIS AND CLARK NF (115) FOR FURTHER PROCESSING.')
          IFOR = 6
        CASE (7302)
          WRITE(JOSTND,68)
   68     FORMAT(T12,'CROW RESERVATION (7302) BEING MAPPED ',
     &    'TO CUSTER NF (108) FOR FURTHER PROCESSING.')
           IFOR = 2
        CASE (7303)
          WRITE(JOSTND,69)
   69     FORMAT(T12,'FORT BELKNAP RESERVATION (7303) BEING MAPPED ',
     &    'TO LEWIS AND CLARK NF (115) FOR FURTHER PROCESSING.')
          IFOR = 6
        CASE (7304)
          WRITE(JOSTND,70)
   70     FORMAT(T12,'FORT PECK INDIAN RESERVATION (7304) BEING ',
     &    'MAPPED TO LEWIS AND CLARK NF (115) FOR FURTHER PROCESSING.')
          IFOR = 6
        CASE (7305)
          WRITE(JOSTND,71)
   71     FORMAT(T12,'NORTHERN CHEYENNE INDIAN RESERVATION (7305) ',
     &    'BEING MAPPED TO CUSTER NF (108) FOR FURTHER PROCESSING.')
          IFOR = 2
        CASE (7307)
          WRITE(JOSTND,72)
   72     FORMAT(T12,'ROCKY BOY''S RESERVATION (7307) BEING MAPPED ',
     &    'TO LEWIS AND CLARK NF (115) FOR FURTHER PROCESSING.')
          IFOR = 6
