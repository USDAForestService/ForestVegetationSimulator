      ...
      IMPLICIT NONE
C----------
C  **MPBIN         DATE OF LAST REVISION:  07/02/10
C----------
C
...
C     =================  OPTION NUMBER 1  -- END =============
 ...
 1020 FORMAT (/1X,A8,'   END OF MOUNTAIN PINE BEETLE OPTIONS.')
      RETURN
...
C     =================  OPTION NUMBER 2  -- PSFOUND =========
 ...
 1220 FORMAT (/1X,A8,'   PROPORTION OF SURFACE TARGETED FOR SPRAYING ',
...
C     =================  OPTION NUMBER 3  -- DCFOUND =========
 ...
 1320 FORMAT (/1X,A8,'   PROPORTION OF ATTACKED TREES SPRAYED ',
     >               '(BY YEAR):'/)
...
C     =================  OPTION NUMBER 4  -- INVMORT  ========
 ...
 1410 FORMAT (/1X,A8,'   USE INVENTORIED CURRENT MPB ATTACK DATA '
     >       '(FVS TREE DATA DAMAGE/SEVERITY CODES).')

      IF(LKECHO .AND. LDAM) WRITE(JOSTND,1411)
 1411 FORMAT (12X,'MPB DAMAGE CODE TABLE WILL BE WRITTEN.')

      IF(LKECHO .AND. .NOT. LDAM) WRITE(JOSTND,1412)
 1412 FORMAT (12X,'MPB DAMAGE CODE TABLE WILL NOT BE WRITTEN.')
      GO TO 10
...
C....  NOTE: BOTH MPBSTART AND MANSTART KEYWORDS GET YOU HERE !!!!!!!!
 ...
 1540 FORMAT (/1X,A8,'   OUTBREAK MANUALLY SCHEDULED FOR CYCLE/YEAR ',
     >       I4)
...
C     =================  OPTION NUMBER 7  -- AGGPHERM  =======
 ...
 1720 FORMAT (/1X,A8,'   POPULATION MULTIPLIERS USED TO ',
...
C     =================  OPTION NUMBER 8  -- REPPHERM  =======
 ...
 1820 FORMAT (/1X,A8,'   POPULATION MULTIPLIERS USED TO ',
...
C     =================  OPTION NUMBER 9  -- DEBUG  ==========
 ...
 1920 FORMAT (/1X,A8,'   MOUNTAIN PINE BEETLE DEBUG ACTIVATED.')
...
C     =================  OPTION NUMBER 10 -- PRBSCALE  =======
 ...
 2040 FORMAT (/1X,A8,'   OUTBREAK PROBABILITY SCALING FACTOR = ',F11.3)
      GO TO 10
...
C     =================  OPTION NUMBER 11 -- RANNSEED  =======
 ...
 2110 FORMAT (/1X,A8,'   RANDOM SEED IS:',F10.0)
      GOTO 10
...
C     =================  OPTION NUMBER 12 -- BETTER  =========
 ...
 2260 FORMAT (/1X,A8,'   CLASSIFICATION IMPORTANCE VALUES',
...
C     =================  OPTION NUMBER 13 -- RANSTART  =======
 ...
 2310 FORMAT (/1X,A8,'   MOUNTAIN PINE BEETLE OUTBREAKS WILL BE ',
...
C     =================  OPTION NUMBER 14 -- NUMCLASS  =======
 ...
 2440 FORMAT (/1X,A8,'   NUMBER OF TREE CLASSES REPRESENTED = ',I5)
      GO TO 10
...
C     =================  OPTION NUMBER 15 -- AMP  ============
 ...
 2540 FORMAT (/1X,A8,'   AGGREGATING TREES HAVE ',F8.1,
...
C     =================  OPTION NUMBER 16 -- ACTSURF  ========
 ...
 2620 FORMAT (/1X,A8,'   ACTUAL SURFACE KILLED PER YEAR : '/)
...
C     =================  OPTION NUMBER 17 -- CRITAD  =========
 ...
 2760 FORMAT (/1X,A8,'   BEETLES PER UNIT SURFACE NEEDED TO CAUSE ',
     >              'TREE DEATH = ',F11.3)
      GO TO 10
...
C.... PRINT OUT KEYWORD MESSAGE BASED ON IF THE FILE OPENS OR NOT.
 ...
 2820    FORMAT (/1X,A8,'   POST PROCESSOR OUTPUT FILE ',A80,/,
     &           12X,'WAS NOT OPENED DUE TO AN ERROR!!!!')
         JOMPBX = 0
      ELSE
         IF(LKECHO) WRITE(JOSTND,2830) KEYWRD, PNAME
 2830    FORMAT (/1X,A8,'   POST PROCESSOR OUTPUT FILE ',A80,/,
     &           12X,'WAS OPENED.')
      ENDIF
      GOTO 10
...
C     =================  OPTION NUMBER 19 -- BEETLES  ========
 ...
 2940 FORMAT (/1X,A8,'   STARTING BEETLE POPULATION PER ACRE = ',F11.3)
      GO TO 10
...
C     =================  OPTION NUMBER 20 -- HABSUIT  ========
 ...
 3040 FORMAT (/1X,A8,'   HABITAT SUITABILITY = ',F11.3)
      GO TO 10
...
C     =================  OPTION NUMBER 21 -- MAXYEARS  =======
 ...
 3140 FORMAT (/1X,A8,'   MAXIMUM YEARS IN MPB PROJECTION = ',I4)
      GO TO 10
...
C     =================  OPTION NUMBER 22 -- STNDSIZE  =======
 ...
 3240 FORMAT (/1X,A8,'   STAND SIZE (ACRES) = ',F11.3)
      GO TO 10
...
C     =================  OPTION NUMBER 23 -- GENOTYPE  =======
 ...
 3340 FORMAT (/1X,A8,'   NUMBER OF GENOTYPES = ',I1,'.  DISTANCE EACH ',
...
C     =================  OPTION NUMBER 24 -- STRONG  =========
 ...
 3440 FORMAT (/1X,A8,'   PROPORTION BEETLES IN GENOTYPE ONE (STRONG) =',
     >      F8.7)
      GO TO 10
...
C     =================  OPTION NUMBER 25 -- EMERINC  ========
 ...
 3540 FORMAT (/1X,A8,'   NUMBER OF EMERGENCE INCREMENTS = ',I4)
      GO TO 10
...
C     =================  OPTION NUMBER 26 -- POPDYN  =========
 ...
 3640 FORMAT (/1X,A8,'   THE MOUNTAIN PINE BEETLE POPULATION DYNAMICS',
     >              ' MODEL WILL BE USED.')
      LPOPDY = .TRUE.
      GO TO 10
...
C     =================  OPTION NUMBER 27 -- NOPOPDYN  =======
 ...
 3740 FORMAT (/1X,A8,'   THE MOUNTAIN PINE BEETLE RATE OF LOSS MODEL',
     >              ' WILL BE USED.')
 ...
 3741    FORMAT (T13,'BOUSFIELD''S ADJUSTMENTS ARE BEING USED.')
      ELSE
         IBOUSE = 0
         IF(LKECHO) WRITE(JOSTND,3742)
 3742    FORMAT (T13,'BOUSFIELD''S ADJUSTMENTS ARE NOT BEING USED.')
      ENDIF
...
C     =================  OPTION NUMBER 28 -- AGGTHRES  =======
 ...
 3840 FORMAT (/1X,A8,'   THRESHOLD OF AGGREGATION = ',F11.3/
     >             T13,'THRESHOLD MAXIMUM = ',F11.3/
     >             T13,'THRESHOLD MINIMUM = ',F11.3/
     >             T13,'CALIBRATION TOLERANCE = ',F11.3)
      GO TO 10
...
C     =================  OPTION NUMBER 29 -- CURRMORT  =======
 ...
 3920 FORMAT (/1X,A8,'   CURRENT MORTALITY BY DBH CLASS=',10F8.3)
      LCURMR = .TRUE.
      LINVMR = .FALSE.
...
C     =================  OPTION NUMBER 30 -- EPIPROB  ========
 ...
 4040 FORMAT (/1X,A8,'   SPECIFIED OUTBREAK PROBABILITY = ',F11.3)
      GO TO 10
...
C     =================  OPTION NUMBER 31 -- MPBGRF  =========
 ...
 4140 FORMAT (/1X,A8,'   MOUNTAIN PINE BEETLE GRAPHICS OUTPUT',
...
C     =================  OPTION NUMBER 32 -- NODEBUG  ========
 ...
 4240 FORMAT (/1X,A8,'   TURN OFF DEBUG OUTPUT.')
      DEBUIN = .FALSE.
      GO TO 10
...
C     =================  OPTION NUMBER 33 -- QVALUES  ========
 ...
 4320 FORMAT (/1X,A8,'   Q VALUES BY DBH CLASS=',10F8.3)
      GO TO 10
...
C     =================  OPTION NUMBER 34 -- INITMORT  =======
 ...
 4420 FORMAT (/1X,A8,'   INITIAL MORTALITY BY DBH CLASS=',10F8.3)
      GO TO 10
...
C     =================  OPTION NUMBER 35 -- NOMPBGRF  =======
 ...
 4540 FORMAT (/1X,A8,'   MOUNTAIN PINE BEETLE GRAPHICS OUTPUT',
...
C     =================  OPTION NUMBER 36 -- PSDBHLIM  =======
 ...
 4620 FORMAT (/1X,A8,'   SMALLEST SIZE TREE (DBH) TREATED WITH ',
...
C     =================  OPTION NUMBER 37 -- PSPKILL  ========
 ...
 4720 FORMAT (/1X,A8,'   PROPORTION OF BEETLES KILLED LANDING ON ',
...
C     =================  OPTION NUMBER 38 -- DCPKILL  ========
 ...
 4820 FORMAT (/1X,A8,'   PROPORTION OF BEETLES KILLED WITH DIRECT ',
     >    'CONTROL (BY YEAR):'/)
...
C     =================  OPTION NUMBER 39  -- LATITUDE  ======
 ...
 4940 FORMAT (/1X,A8,'   FOREST LATITUDE = ',F4.1,' DEGREES.')
      GO TO 10
...
C     =================  OPTION NUMBER 40  --  PARTIAL  ======
 ...
 5040 FORMAT (/1X,A8,'   CURRENT EPIDEMIC IS IN YEAR ',I4,', ')

      IF (LSADLP.AND.LKECHO) WRITE(JOSTND,5060) SADLPP
 5060 FORMAT ('+',T50,'SURFACE AREA OF DEAD LODGEPOLE =',F11.3)

      IF ((.NOT.LSADLP).AND.LKECHO) WRITE(JOSTND,5080)
 5080 FORMAT ('+',T50,'SURFACE AREA OF DEAD LODGEPOLE ',
