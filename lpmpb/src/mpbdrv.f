...
C
     ...
     >            A6,A7,A8,PROB,KODE,MAXCLS,ITWO)
      ...
      WRITE  (JOMPB,30)
   30 FORMAT (/' ***** ERROR:  SUBROUTINE GARBEL FAILED')
   40 CONTINUE
C
...
C
C*    WRITE (JOMPB,62)
C* 62 FORMAT ('1CLASS    MPISC  II    I     DBH',
...
C* 65 FORMAT (14X,2I5,F10.2,F10.4,F10.2,F12.5)
C* 70 CONTINUE
...
C
  ...
  170 FORMAT ('0MPBYR = ',I3,' MPBGRF = ',L2)
...
C
      CALL MPBHED
      WRITE (JOMPB,180)
  180 FORMAT (/,T8,'** ATTACK, EMERGENCE & PIONEER DENSITIES',
