      ...
      IMPLICIT NONE
C----------
C  **MPBMOD        DATE OF LAST REVISION:  07/02/10
C----------
C
...
C
  440 CONTINUE
      ...
      GO TO 8
C
 4950 FORMAT ('0',40('*'),10X,'STAND HAS BEEN UPDATED',
     >        10X,40('*'),//)
 5000 FORMAT (    T10,'DIAMETER CLASSES',5(T2,'ID',T40,10F9.2,/))
 6000 FORMAT ('0',T10,'SURFACE AREA/TREE',5(T2,'IS',T40,10F9.2,/))
 6030 FORMAT ('0',T10,'TREES/ACRE',5(T2,'IT',T40,10F9.2,/))
 6100 FORMAT('0IE',T10,'EXODUS(',I1,') =',F8.5,
     :       ';  FM1(',I1,') =',F8.5)
 ...
 6250 FORMAT ('0',T4,I5,T10, 'DIAMETER CLASSES',5(T2,'DC',T40,
     >        10F9.2,/))
 6300 FORMAT ('0',T4,I5,T10, 'SURVIVING TREES/ACRE',5(T2,'ST',T40,
     >        10F9.2,/))
 6325 FORMAT ('0',T4,I5,T10, 'T/A KILLED THIS YEAR',5(T2,'TK',T40,
     >        10F9.2,/))
 6350 FORMAT ('0',T4,I5,T10, 'CUMULATIVE MORTALITY',5(T2,'CM',T40,
     >        10F9.2,/))
 6400 FORMAT(/T40,'   EMERGENCE      EXODUS  MORTALITY1  MORTALITY2',
     :             '  MORTALITY3   SURVIVORS')
 6450 FORMAT(' B',I1,I5,T10,'BEETLES -- GENOTYPE ',I1,T40,6F12.3)
 6500 FORMAT(' TB',I5,T10,'TOTAL BEETLES',T40,6F12.3/' B')
 6550 FORMAT(' %',I1,I5,T10,'% GENOTYPE(',I1,')',T40,6F12.3)
 6600 FORMAT(' %T',I5,T10,'% TOTAL',T40,6F12.3/' %')
 6650 FORMAT(' S ',I5,T10,'SURFACE KILLED =',F10.2,';',
     :       '  CUMULATIVE SURFACE KILLED =',F10.2,';',
     :       '  OFFSPRING =',F10.2,';',
     :       '  NEXT P =',F8.5,
     :      /' D ',I5,T10,'ATTACK DENSITY =',F8.4,';',
     :           ' EMERGENCE DENSITY =',F8.3,';',
     :           ' EMERGENCE/ATTACK =',F8.3,';',
     :           ' PIONEER DENSITY =',F12.8)
 6700 FORMAT ('0',25('*'),'    NOTE:  EPIDEMIC IS EXTENDING',
     :        ' PAST THE LAST TREE GROWTH CYCLE YEAR    ',
     :        25('*'))
 6800 FORMAT ('0SADLPP = ',F10.2)
 6900 FORMAT(/' PERIODIC GROWTH RATIO = ',F5.3,' RESIST = ',F5.2,
     >       '  THRESHOLD OF AGGREGATION = ',F5.2/)
 7000 FORMAT ('0PHLOEM = ',20F6.3)
 7100 FORMAT ('0EFPHLM = ',20F6.3)
 7250 FORMAT ('0SEXDBH = ',20F6.3)
 7200 FORMAT ('0EFELEV = ',F4.2,'  EFLAT = ',F4.2)
 7400 FORMAT ('1',100('*')/'0RESIST = ',F5.2,'  TA = ',5F5.2)
      END
