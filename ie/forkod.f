...
C       CROSSWALK FOR RESERVATION PSUEDO CODES & LOCATION CODE
        CASE (8106)
          WRITE(JOSTND,70)
   70     FORMAT(T12,'COLVILLE RESERVATION (8106) BEING MAPPED ',
     &    'TO COLVILLE NF (621) FOR FURTHER PROCESSING.')
          IFOR = 5

        CASE (8107)
          WRITE(JOSTND,71)
   71     FORMAT(T12,'NEZ PERCE RESERVATION (8107) BEING MAPPED ',
     &    'TO NEZ PERCE NF (117) FOR FURTHER PROCESSING.')
          IFOR = 10

        CASE (8109)
          WRITE(JOSTND,72)
   72     FORMAT(T12,'KOOTENAI OFF-RES. TRUST (8109) BEING MAPPED ',
     &    'TO KANIKSU NF (113) FOR FURTHER PROCESSING.')
          IFOR = 7

        CASE (8131)
          WRITE(JOSTND,73)
   73     FORMAT(T12,'SPOKANE RESERVATION (8131) BEING MAPPED ',
     &    'TO COLVILLE NF (621) FOR FURTHER PROCESSING.')
          IFOR = 5

        CASE (8132)
          WRITE(JOSTND,74)
   74     FORMAT(T12,'KALISPEL RESERVATION (8132) BEING MAPPED ',
     &    'TO KANIKSU NF (113) FOR FURTHER PROCESSING.')
          IFOR = 7

        CASE (8133)
          WRITE(JOSTND,75)
   75     FORMAT(T12,'FLATHEAD RESERVATION (8133) BEING MAPPED ',
     &    'TO FLATHEAD NF (110) FOR FURTHER PROCESSING.')
          IFOR = 6

        CASE (8137)
          WRITE(JOSTND,76)
   76     FORMAT(T12,'COEUR D''ALENE RESERV. (8137) BEING MAPPED ',
     &    'TO ST. JOE NF (118) FOR FURTHER PROCESSING.')
          IFOR = 11
