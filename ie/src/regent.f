      ...
      IMPLICIT NONE
C----------
C  **REGENT--NI23   DATE OF LAST REVISION:   09/21/11
C----------
...
C----------
      IF(NIVAR)THEN
        H2=H1+EXP(HTGRL)*(FLOAT(KPER(J))/REGYR)*XRHGRO*XPPMLT*WK4(I)
      ELSEIF(TTVAR)THEN
        H2=H1+HTGRL*(FLOAT(KPER(J))/REGYR)*XRHGRO*CON*WK4(I) + XPPMLT
      ELSE
        H2=H1+HTGRL*FLOAT(NTYR)/10. + XPPMLT
      ENDIF
      WK3(I)=H2
