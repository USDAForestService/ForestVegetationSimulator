      ...
      IMPLICIT NONE
C----------
C ESTB $Id: esuckr.f 0000 2018-02-14 00:00:00Z gary.dixon24@gmail.com $
C
...
C----------
      NSPRT = 0
      CALL NSPREC(VARIANT,ISSP,NSPRT,DSTMP)
      NUMSPR = NSPRT
...
C----------
      IF(DEBUG)WRITE(JOSTND,*)'CALLING ESSPRT VARIANT,ISSP,NUMSPR,PREM,
     &DSTMP= ',
     &VARIANT,ISSP,NUMSPR,PREM,DSTMP 
      CALL ESSPRT(VARIANT,ISSP,NUMSPR,PREM,DSTMP)
...
C----------
      ...
      HTI = 0.
      IF(DEBUG)WRITE(JOSTND,*)'BEFORE SPRTHT VARIANT,ISSP,SI,ISHAG= ',
     &VARIANT,ISSP,SITEAR(ISSP),ISHAG 
      CALL SPRTHT (VARIANT,ISSP,SITEAR(ISSP),ISHAG,HTI)
