...
C
  ...
  140 FORMAT (T9,'FOREST VEGETATION SIMULATOR',
...
C
  ...
  240 FORMAT (T9,'FOREST VEGETATION SIMULATOR',
...
C
  ...
  340 FORMAT (T9,'FOREST VEGETATION SIMULATOR',
...
C
  ...
  440 FORMAT (T9,'FOREST VEGETATION SIMULATOR',
...
C
  ...
  540 FORMAT (T9,'FOREST VEGETATION SIMULATOR',
