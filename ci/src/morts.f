      ...
      IMPLICIT NONE
C----------
C  **MORTS--CI  DATE OF LAST REVISION:  09/20/11
C----------
...
C  THESE ARE SET TO RETRIEVE NI NEZPERCE COEFFICIENTS FOR ALL CI FORESTS
C  RIGHT NOW, BUT MAY BE CHANGED.  GED 9/20/11
C
      DATA MAPFOR/ 10, 10, 10, 10, 10, 10/
C-----------
C  CHECK FOR DEBUG.
C-----------
